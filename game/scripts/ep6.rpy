...
label ep6_pl_bedrooom:
    ...
    "[EM]'s got a nice body... Don't know why she's always complaining. I got a good look so I know what I'm talking about..."
    ...
    "I did take those painkillers just before the ummm... \"incident\"."
    hide screen INT with dissolve1
    ...
    "I already got a pre-existing head injury here! Show a bit more concern at least! But nooo... all they did was drag me to bed and left me for dead...."
    ...
    $ renpy.pause (delay=1.5)
    show screen INT with dissolve1
    "Wonder if [EM]'s the one that put me to bed last night. Nah... don't think she's strong enough to drag 190 pounds of dead weight just by herself."
    ...
    PL "Lying there after getting KO'd by a girl in a pool of my own piss... urghhh!"
    scene ep6_plroom21 with dissolve
    PL "Hmmm?"
    PL "Isn't that..."
    scene ep6_plroom22 with dissolve
    PL "Yep, it's the murder weapon alright!"
    PL "Shit, look at this thing! It's fucking deadly! I wouldn't throw something like this at someone's head!"
    PL "That girl's got issues... What would she have done if my head wasn't so hard?"
    ...
    PL "I've been here just a few days and I'm already like this. Cast on my arm, stupidly large bandage on my head..."
    PL "And now a black eye to top it all off..."
    stop music fadeout 2
    scene black with fade
    PL "Am I really gonna survive an entire six months of this?"
    ...
    LU "Ha ha ha! Did you get on her shitlist? What'd you do?"
    ...
    PL "Gonna ask her now actually. She's sleeping in my room for some reason. Woke up and found her at the foot of the bed."
    LU "WHAT?"
                ...
                "[gr]*Look closer.*" if True:
                    ...
                    menu:
                        "[gr]*Look even closer.*" if True:
                            ...
                            "But, goddammit, Just look at that! She looks sooo good..."
                            hide screen INT with dissolve1
                            menu:
                                "[gr]*Reach for it...*" if True:
                                    scene ep6_plroom44 with dissolve
                                    pause
                                    show screen INT with dissolve1
                                    "It'd be so easy just to reach out and give it a little rub... Just to see what it actually feels like."
                                    "It's so close! Right in front of me, fully exposed. All I have to do is..."
                                    hide screen INT with dissolve1
                                    menu:
                                        "[gr]*A little bit more...*" if True:
        ...
        "[gr]*Wake her up.*" if True:
            ...
            menu:
                "[gr]*Try again.*" if True:
                    ...
                    "Or I could do something that I know for sure is gonna wake her up instantly. It'd solve everything, but I run the risk of another headshot."
                    menu:
                        "*Tease her with words.* [EmilyLovePath]" if q1 == 1:
                            ...
                            PL "Well, I did think about giving you a kiss instead but..."
                            ...
                            if ep4_EMfirstkiss == 2:
                                ...
                                EM "Like how you made me kiss you on the cheek at the hospital? Something like that is kinda sweet, I guess..."
                                EM "But it wouldn't make me happy if you do it to me now! I'm still mad about last night."
                        ...
                        "*Give her a little spank.* [EmilyCorruptionPath]" if q2 == 1:
                            ...
                            PL "Oh, and you thought I was your mom and you were back in high school... I was out of options... Had to do something."
                            EM "{cps=10}....{/cps}"
                            scene ep6_plroom72 with dissolve
                            EM "Ughhh... fine! You get a free pass this time. But wake me up like that again next time and I won't forgive you!"
                            PL "Next time? You're planning on sleeping in my room again?"
                            EM "That's not what I meant! Ughhh... you know what? Forget it!"
...
label ep6_EMstorytime:
    ...
    if emCP >=15:
        ...
        EM "Pffft! That's the stupidest thing I've ever heard..."
        EM "{cps=10}....{/cps}"
        hide screen c_pass
    elif True:
        if not _in_replay:
    ...
    AS "Slow down! First of all, mind explaining why this fool is laid out on the floor?"
    AS "Did his meds kick in too early? Or did he raid [SG]'s wine cabinet while no one's looking?"
    ...
    play sound aslaugh
    AS "HA HA HA HA HA!"
    AS "That's hilarious! You did something like that to a guy with a head injury? You're just as vicious as ever! Way to go, [EM]!"
    AS "Ha ha ha.... Oh god... wish I could've seen it for myself!"
    menu:
        "\"Wait, what?\"" if True:
...
label ep6_interrupt1:
    ...
    EM "It's not funny, Ash! What if he's really hurt? I'd never be able to forgive myself!"
    EM "I'm sure he didn't do it on purpose trying to perv. It must've been an accident!"
    ...
    AS "How 'bout we deal with this ourselves? I'm sure he's alright... He's got a hard head."
    AS "I mean... that big scary bad guy couldn't crack his skull, so I doubt you'd do any permanent damage."
    ...
    EM "I don't know, Ash.... What if there's something really wrong with him?"
    EM "Shouldn't we at least call that lady doctor that was treating him at the hospital?"
    EM "If you could just please go and get [SG], I'm sure she'd know how to get in touch with her."
    EM "Then she'd be able to tell us if there's any cause for worry."
    scene ep6_sbathroom11 with dissolve
    AS "Ughhh! You're giving me a headache. Listen, he's fine. Dude is just sleeping it off."
    AS "I heard from [LU] that it's only dangerous if they start snoring."
    ...
    AS "Listen to this guy... He's not snoring, is he? He's completely fine! He's just sleeping peacefully."
    AS "Probably tired from playing games all day... Nothing to do with you at all!"
    if ep3_KUflirt == 1:
        ...
        AS "You definitely don't want her over here making a fuss over him."
        AS "I don't know about you, but I'm getting tired of seeing people, especially the girls, getting worked up over this idiot."
    elif True:
        AS "And do you really want to turn this into that big a fuss?"
        AS "I don't know about you, but I'm getting tired of seeing people, especially the girls, getting worked up over this idiot."
    ...
    EM "And he's not snoring either. But that doesn't really mean anything."
    EM "I wouldn't really put much stock into what [LU] tells you. He's just trying to impress you all the time."
    if ep3_KUflirt == 1:
...
label ep6_interrupt2:
    ...
    EM "I'm pretty sure it was just an accident, Ash! I don't think he was trying to peep... He, like, busted the door wide open."
    EM "He wasn't sneaking around or anything."
    ...
    AS "HA, that's rich coming from you! You walk around all day every day without a damn bra on!"
    AS "Or did you just conveniently forget about that? Fuck... do you even own a bra?"
    EM "That's completely different! I'm not like you with your perfect chest! Even if I don't wear one, no one would even notice!"
    EM "And I do own some! I just choose not to wear them..."
    ...
    EM "Ughhh! How're you doing, Ash? You got this?"
    play sound thud
    stop music fadeout 1
    SFX "THUD!" with vpunch
    ...
    AS "Huff... huff... I'm seriously gonna make this dumb bastard pay for this tomorrow."
    AS "This idiot better appreciate this, [EM]! If it was me, I would've just left him on the bathroom floor."
    ...
    EM "I lent it to him last night..."
    EM "Kinda felt sorry for him for getting hurt and having to stay home with nothing to do so I let him borrow that to help pass the time."
    AS "Damn... Girl, you're almost as bad as [SG]! Why are you two babying him so much?"
    AS "And that thing is on his bed... Bet you he was using it to watch porn."
    ...
    AS "Maybe you should strip off, climb into bed with him, and give him a cuddle!"
    AS "You can make sure he stays nice and warm that way! We don't want him to freeze to death, do we?"
    EM "{cps=10}....{/cps}"
    ...
    AS "We?"
    AS "Fuck that! {b}We{/b} aren't doing anything. You can stay and babysit if you want, but I've done my good deed for the day..."
    AS "Fuck! I'm all sweaty and tired coz of this idiot..."
    AS "I'm gonna go take my shower. You've wasted your turn so now it's mine."
    AS "After that, I'm going straight to bed. Don't bother me again with this unless he's really dying or something, okay?"
    ...
    hide screen INT with dissolve1
    scene ep6_sbathroom30 with fade1
    stop music fadeout 6
    EM "{i}I'm so stupid for throwing things like that. Always hurting the people around me...{/i}"
    EM "{i}Got to stop being so violent any time I get angry or flustered...{/i}"
    EM "{i}You need to grow up, [EM]! Be mature and calm like [SG], or be more like Ash... She doesn't let anything get to her.{/i}"
    EM "{cps=10}....{/cps}"
    EM "{i}Well, might as well get comfortable... It's going to be a long night...{/i}"
    EM "{i}But first, I should go put this away in my room... Really don't feel like having fun right now.{/i}"
    scene black with fade1
    play music em1 fadein 4
    scene ep6_sbathroom31 with dissolve
    EM "{i}Hmmm... As far as I can tell, it looks like [PL] is doing okay. I think he's just sleeping right now.{/i}"
...
label ep6_endEMstorytime:
    ...
    EM "Ummm.... I am too of course! It's not like I want to hide it from her or anything..."
    EM "Just that I'd rather her not know I knocked you out cold just days out of the hospital."
    ...
    menu:
        "\"Wait, [EM]!\" [EmilyPath]" if True:
            ...
            label ep6_EMkisssceneR:
                ...
                menu:
                    "[gr]*I'm not giving up just yet!*" if True:
                        ...
                        PL "C'mon, [EM]. You threw something at me... Gave me a black eye too! I think a kiss isn't too much to ask in return for all my suffering."
                        ...
                        if emLP >=20 or emCP >= 15:
                            ...
                            hide screen INT with dissolve1
                            if ep4_EMfirstkiss >= 2:
                                EM "But no forcing your lips on me like last time! A kiss on the cheek is all you're gonna get!"
                                ...
                                EM " I don't know..."
                                PL "It really hurt! You could've opened up my stitches and made me bleed to death..."
                                scene ep6_plroom95 with dissolve
                            ...
                            EM "Goodbye!"
                            jump ep6_EMleaving
                    "*Let's leave the poor girl alone.*" if True:

                        scene ep6_plroom98 with dissolve
                        EM "Ughhh! That's it... I'm going! You should get ready too!"
                        EM "Goodbye!"
                        jump ep6_EMleaving
        "*It's fine. She looks okay." if True:
...
label ep6_EMkissscene:
    ...
    menu:
        "[gr]*Kiss her.*" if True:
            ...
            "What do I do now though? This is the first time I've gotten to first base with a girl!"
...
label ep6_weekvignette:
    ...
    pause
    AZ "Such as hanging out with [LU] during one of his weightlifting sessions. You tried your best to coax some workout tips out of the guy while you were at it."
    ...
    AZ "True to her word, [SG] kept a close eye on you to make sure you took a bath at least once a day."
    ...
    AZ "But still... you somehow get the feeling she enjoyed putting you on the spot like that. She probably finds your embarrassment funny."
...
label ep6_newday:
    ...
    SG "Plus, everyone's been saying I've been doting on you too much. Let's prove them wrong, okay? Show them you can do things for yourself!"
    PL "{cps=10}....{/cps}"
    ...
    SG "Did something happen between you two? Something to do with that black eye perhaps?"
    PL "!!!"
    ...
    if ep3_KUflirt == 1:
        "It could also be down to the fact that she hates the doc's guts and doesn't want me to meet with her alone maybe?"
    ...
    SG "Though I am a bit upset that [EM] didn't come to me for help and is keeping secrets from me... Must be [AS]'s influence... hmph!"
    ...
    menu:
        "*Let's go!*" if True:
            $ quick_menu = False
            scene black with irisin
            centered "{size=35}{cps=20}After a quick bath and breakfast...{/cps}{/size}{w=2.5}{nw}"
            ...
            AS "Awww.... does innocent, lil' [EM] think of this as a sweet first date?"
            ...
            SG "Don't let her get to you, [EM]. You look wonderful! It's nice seeing you dress up all ladylike for a change."
            ...
            label ep6_newdayqmenu1:
                ...
                menu:
                    "*Defend [EM]* [EmilyPath]" if q1 == 0:
                        ...
                        EM "Yeah! Who cares what you thin,k Ash! I'm wearing this coz I wanted too... It's got nothing to do with you!"
                        EM "BLEH!"
                        $ q1 = 1
                        $ q3 = 1
                        $ emLP += 1
                    "*Get some payback for [EM]!*" if q2 == 0:
                        hide screen INT with dissolve1
                        scene ep6_newday13 with dissolve
...
label ep6_stationtrans:
    ...
    AS "Right, [EM]?"
    EM "Ummm... yeah... Gosh, it sure is hot today..."
    scene ep6_stationtrans2 with dissolve
    PL "So how far do we have to walk anyway? You guys do this every day?"
    PL "Not that I'm complaining... it's awesome walking around flanked by two hotties like this!"
    AS "Ewwww! Disgusting! Aren't you ashamed of yourself? Spouting ridiculous lines like that?"
    ...
    EM "And don't talk about [PL] like that. Don't lump him in with the guys you've known in the past. He's not like them! "
    ...
    AS "She should know there are a bunch of sleaze balls out there just waiting to pounce on someone like her! I mean... there's one walking next to me right now!"
    PL "Hey!" with vpunch
    ...
    $ quick_menu = False
    scene black with fade
    centered "{size=35}{cps=20}Soon after...{/cps}{/size}{w=2.5}{nw}"
    ...
    AS "Ah shut up... she does things for you too. Running around taking care of you like some obedient little wifey. If anything, you're worse than me."
    ...
    PL "And I help her out too. Just this past week, I did all the house chores with her and stuff."
    ...
    AS "Stop running around like a hyperactive monkey! You're wearing a short skirt, remember?"
    ...
    EM "Hmmm? I dunno... I think you're both just as bad."
    call treset
...
label ep6_ASexposeEM:
    ...
    if ep5_ASlivingroomfp == 1:
        ...
        EM "I just wish that the only thing you two seem to agree on was't picking on me!"
        ...
        AS "Relax... no one in here but us!"
        AS "Oh, and [PL]... but he's already seen you naked and, from what I've heard, you guys already slept together on the same bed too so... who cares?"
        EM "!!!"
        hide screen alt_cam_flash with dissolve1
        ...
        AS "Don't you see? I'm actually doing you a huge favor here. You should be thanking me instead of getting mad."
        play sound gasp
        ...
        show screen INT with dissolve1
        "Though family don't get boners from seeing each other's underwear... and I fucking got one right now, goddammit!"
        hide screen INT with dissolve1
        ...
        EM "How about nothing! I'm done with all of this. Grrr... you two make the perfect pair... a male and female deviant! Just start dating each other, why don't you!"
...
label ep6_ASexposeEMpass:
    if Temp == 0:
        scene ep6_stationtrans39 with fade
        EM "It's fun seeing you two bicker though... I don't see people talk back to [AS] much so it's really funny."
        EM "I just wish that the only thing you two seem to agree on wasn't picking on me!"
        scene ep6_stationtrans41 with dissolve
        stop audio fadeout 4
        $ renpy.pause (delay=1.5)
        scene black with fade
    scene ep6_stationtrans62 with dissolve
    PL "So, ummm... [EM], I heard from [SG] you actually took a day off just to accompany me today. Thanks for that."
    PL "It would've been kinda scary if I had to do this by myself."
    ...
    AS "Awww... isn't that precious? Little [PL] is scared to do things on his own..."
    ...
    EM "No, it's fine... the shop's still open. [NA] can handle things on her own mostly."
    EM "She just won't have anyone to serve the tables. She'll just stand at the counter and take the orders."
    ...
    EM "Well, kinda... the guy didn't make a huge scene or anything, but he did drag his girlfriend out and storm off."
    ...
    SG "Oh, nothing much, just [NA] up to her usual tricks again. Making all sorts of trouble at her own place."
    SG "She's going to run the place into the ground if she doesn't watch out."
    scene ep5_ALdinner3 with dissolve
    EM "It's fine... {w=1}I think. Despite how she is, the shop's doing pretty good."
    EM "And lots of people like [NA]. Her horrible flirting causes some trouble sometimes but nothing too bad."
    EM "Most of the regulars knows that about her anyway, so they just deal with it."
    EM "I don't think [NA]'s all that serious about it too. She's mostly just messing around, I think."
    ...
    hide screen INT with dissolve
    scene ep6_stationtrans62 with dissolve
    PL "Ummm... hey... I've kinda been wondering something about [NA]. Is it true that she goes for the ladies?"
    PL "I overheard you talking about it with [SG] a while back."
    EM "{cps=10}....{/cps}"
    scene ep6_stationtrans61 with dissolve
    EM "I don't see how that is any of your business! Out of all the things you could be curious about, it just had to be that!"
    EM "Typical... HUMPH!"
    ...
    scene ep6_stationtrans62 with dissolve
    PL "Uhhh... well, okay... Still, I'm glad she let you off work today. Gotta remember to say thanks next time we meet."
    PL "{cps=10}....{/cps}"
    ...
    PL "I'd rather stare at a really nice girl's butt anyway..."
    ...
    AS "Pffftt... ha ha ha! Nice comeback! I'll give you points for that. That was hilarious."
    ...
    AS "No, no, nothing going on at all... you'd definitely be the first to know if something's up with me."
    AS "I don't know what this idiot is talking about. His head injury must be acting up."
    EM "Uh... well... okay... if you say so..."
    ...
    EM "Me and [PL] can just kill some time and wait till then maybe. Or we could go pick you up at the shop."
    EM "It's safer that way... It's your choice... What do you think?"
    EM "{cps=10}...{/cps}"
    ...
    EM "You're so silly! Why would you even expect that? Despite what she says, she's not really our mom, you know."
    EM "And even if she is, you're a little old to be expecting gifts."
    PL "{cps=10}....{/cps}"
...
label ep6_EMKUhospital:
    ...
    PL "I'm complaining a lot coz it's you.... like you're this wife-slash-mom-slash-girlfriend person I'd like to win over."
    PL "If it was [AS], I'd just soldier on and keep it to myself."
    ...
    PL "Hey, [EM]! Wait up!"
    EM "NO!"
    EM "Get you butt in gear! We need to get you looked at ASAP!"
    stop music fadeout 4
    scene black with fade1
    $ renpy.pause (delay=2)
    ...
    if ep3_KUflirt == 1:
        ...
        PL "It sounds really weird when someone so young and not to mention pretty calls me that."
        scene ep6_EMKUhospital23 with dissolve
        UN "{cps=10}....{/cps}"
        scene ep6_EMKUhospital26 with dissolve
    ...
    PL "It wasn't irrelevant though... All I did was ask her if we could go straight in after you're done..."
    ...
    $ quick_menu = False
    scene black with fade1
    centered "{size=35}{cps=20}After some time being grilled by [EM]...{/cps}{/size}{w=2.5}{nw}"
    ...
    UN "Thank you."
    EM "So... ummm... can I go in with him?"
    scene ep6_EMKUhospital36 with dissolve
    UN "Hmmm... I don't see why not if that's what you want."
    UN "Just head over through that door back there. Her office is towards the back... Just look for her nameplate next to the door."
    ...
    scene black with fade1
    PL "Is this it?"
    EM "Sure is. Her name's next to the door..."
...
label ep6_catfight1:
    ...
    if ep3_KUflirt == 1:
        ...
        EM "Also, you can drop the \"Miss\", Doctor. It's okay... I don't mind... It just sounds a little strange hearing that from someone so much {b}older{/b} than me."
        KU "!!!"
        ...
        if disable == 1:
            scene ep3_EMKUvisit7 with c_male
        ...
        PL "And, Doc, [EM] doesn't have any ulterior motive or anything. She's just helping me out since I got no clue what I'm doing."
        ...
        EM "I asked [SG] if I could be the one to do it as a favor to this guy. Ummm... some stuff happened so I thought I owed it to him."
        ...
        KU "But nevermind that. It is nice to see you again, Miss [EM]... I mean, [EM]."
        scene ep6_EMKUhospital50 with dissolve
        KU "Why don't you have a seat first? There are a few questions I would like to ask before we get to the actual examination."
        KU "You too, Miss... I mean, [EM]. Please have a seat."
    $ renpy.end_replay()
    ...
    KU "Ummm yes... I agree with you on that. But, sadly, while I can see to his injuries, I don't think I can fix his crooked personality."
    ...
    KU "So she is a bit overprotective of me... Please do not mind what she says too much. In fact, feel free to ignore her words."
    ...
    PL "It's been good, nothing to complain about. I was in a little bit of pain the first couple of days but other than that, it's all been pretty normal."
    ...
    PL "I wanna have a real start to my new life already... Feels like I've been in a holding pattern since the day I got hurt."
    ...
    PL "Wait, so I'm gonna be awake the entire time? Ummm... will it hurt much?"
    ...
    EM "Hmmm... it doesn't look that bad to me. I think dentist chairs are scarier, or the gynecologist ones... Those are terrifying. This one is pretty normal."
    EM "Get on it.{fast}"
...
label ep6_catfight2:
    ...
    if ep3_KUflirt == 1:
        ...
        KU "It would be like walking in on your younger sister... a much younger, {b}underdeveloped{/b} sister."
    ...
    PL "{cps=10}....{/cps}"
    PL "Ummm... I guess... it couldn't hurt, right? Just make sure to keep this a secret, okay? 'Specially from [AS]! I'd never be able to live it down."
    ...
    PL "But, well... I'm only nineteen... This is the first real scar on my face. Let's hope I get a few more in the future so I can look super hardcore."
    KU "{cps=10}....{/cps}"
    EM "Idiot!"
    ...
    PL "Uggghhh... something else I have to look forward to, but at least getting the cast off won't hurt much..."
    PL "Right?"
    ...
    EM "Lunch is next... [SG] made me promise her that I'd feed you too. She gave me some money, so I'll be taking you to my usual lunch spot."
    EM "Me and Ash usually go there almost every day during our break. It's a great place... I'm sure you'll like it."
    ...
    PL "Oh, right. Damn, it's gonna suck having to do that every day."
    KU "Hmmm...."
    scene ep6_EMKUhospital111 with dissolve
    ...
    PL "The more the merrier I say... Plus, we won't have to hoof it."
    if ep3_KUflirt == 1:
    ...
    PL "WOW!" with vpunch
    PL "That's your car, Doc? That's a bloody classic! You might not look the type but you're a hardcore gearhead, aren't you?"
...
label ep6_EMKUlunch:
    ...
    scene black with fade1
    play sound driveby
    centered "{size=35}{cps=20}A bit later...{/cps}{/size}{w=2.5}{nw}"
    stop music fadeout 2
    $ quick_menu = True
    ...
    EM "Didn't your mom ever tell you not to judge a book by its cover?"
    PL "No, not really..."
    ...
    GA "So don't you worry, your food's safe even if you do start getting frisky..."
    GA "Don't know about outside of the kitchen though... he might break your neck! Ha ha ha!"
    scene ep6_EMKUlunch13 with dissolve
    ...
    KU "At the hospital, I count Mari as a friend, and there are a few other nurses I talk to, but we don't really get together outside of work."
    ...
    AZ "[EM], as usual, was oblivious to everything that wasn't on her plate... and ignored the two of you the entire time."
    AZ "Before you knew it, all three of you were staring at empty plates and nursing full bellies."
    ...
    PL "Oh... thanks a bunch! I don't know how it was at your facility but at mine... they didn't exactly have a fancy hairdresser, you know?"
    PL "They just rounded us up like a bunch of sheep and had our heads shaved every month."
...
label ep6_stationwalk:
    ...
    "Hmmm... I need to think this through a little more. [EM]'s too scared to take the first step... scared that everything might blow up in her face."
...
label ep6_EMASstation:
    ...
    AS "Pffft... what a couple of bleeding heart softies... Of all things to worry about, you guys get worked up over a little scar? ...So damn embarrassing!"
    ...
    AS "Pffft! That's it? That's nothing, dude! Looks like you got scratched by a cat!"
...
label ep6_rASpass:
    ...
    show screen tip(message= "Tip: This next choice effects future interactions with Emily/Ashley.")
    menu:
