...
define audio.loop2 = "audio/music/piano-memories-bbc-1215-69.mp3"
...
OM "Listen kid, how many times I gotta tell you to show me some god damn respect! I'm your Probation Officer not your friend."
show screen INT with dissolve1
"This big tub of lard over here is [OM]. A Probation Officer the court assigned to me after I got out of juvie."
...
PL "Well, in your capacity as my P.0, please tell me how much longer I'm gonna be stuck in here with you?"
...
"Didn't help that I hated that guy's guts and have a lot of practice tuning him out."
hide screen INT with dissolve1
menu:
    "\"With all your experience, I'd rather hear it from you.\" [MonroePath]":
        $ omFP += 2
        jump omGlad
    "\"Didn't care much for the guy so I didn't listen.\"":
        jump omLecture

label omLecture:
    scene ep1_OMangry with dissolve
    OM "Kid, you need to work on your attitude. You need to listen when adults talk, especially when someones trying to help you."
    OM "What did all the time you spend in juvie for anyway?"
...
label omGlad:
    ...
    OM "Well yeah, I have been doing this for a long time. Must've watched over hundreds of kids like you over the years."
    OM "Some went back to their old ways despite my efforts."
    OM "But many turn their lives completely around!"
    OM "Now I'm not saying thats all due solely to my efforts alone, but you've gotta give credit where credit is due! Ha ha.."
    show screen INT with dissolve1
...
label cp_car_exp:
    ...
    OM "There's two girls still subjected to a probationary period and a guy who's actually a free man."
    OM "Seems he's decided to start paying rent and stay till he can find a full time job."
    scene ep1_OMdrive with dissolve
    ...
    OM "And like I said it's not a \"facility\". It's just like a regular ol' house."
    ...
    OM "Like you, everyone there are considered adults by law."
    OM "You went into juvie as minors and passed majority by the time you got out."
    OM "That's why you're going to Turning Point and not a state run orphanage or sent packing back to your parents."
...
menu:
    ...
    "\"Tell me about the woman who runs the place\"" if q2 == 0:
        $ q2 = 1
        scene ep1_OMhappy with dissolve
        OM "[SG] Gail, now there's a woman!"
        OM "Her mother is the one that started Turning Point and [SG] only came back to run things after her mother passed on a couple years ago."
        ...
        OM "Off the records!" with vpunch
    ...
    "\"What's actually gonna happen to me there?\"" if q3 == 0:
        ...
        OM "There's mandatory individual and group counseling sessions to help you with all of that or any other emotional issues."
        ...
        OM "Oh! And everyone also have to go through drug tests from time to time."
        ...
        OM "Or mushrooms, or what ever the hell you kids get into these days!"
        scene ep1_OMtalk with dissolve
...
label car_expdone:
    ...
    "Goddamn I'm looking forward to meeting these girls. I just hope I don't make a fool of my self though."
    "Heh, maybe I should act like a tough guy ex-con or something. I hear girls like that."
    "Or maybe I should just be myself, well depends on the girl I guess. We'll have to see."
    "Wait!" with vpunch
    "[OM] still haven't told me when we'll actually get there yet."
    hide screen INT with dissolve1
scene ep1_OMtalk with dissolve
PL "Hey [OM]! You still haven't answered my question!"
scene ep1_OMangry with dissolve
OM "What? I've been doing nothing but answering your damn questions!"
...
OM "Nice place huh? Come on, lets go knock on the door and do the meet and greet."
scene ep1_OMarrive with dissolve
OM "Now kid, behave yourself and don't be rude."
OM "This woman is gonna be like a mother to you for as long as your stay."
...
label joke_option1:
    hide screen INT with dissolve1
menu:
    "\"It's cool man, You look just fine.\" [MonroePath]":
    ...
    "\"Yeah, your shirt's a mess.\"":
        ...
        OM "None of your damn business! And be quiet I can here Ms. Gail coming."
        $ Temp = 0
...
"I can see why [OM] is so smitten with her."
hide screen INT with dissolve1
label SGbpodypan:
...
label omgreetkiss:
    ...
    OM "*Kiss"
    SG "Why hello [OM], It's nice to see you again. I hope the drive over wasn't too taxing?"
    ...
    SG "I'm glad to hear that [OM], you're always a welcomed sight. And is this young man my new charge?"
...
menu:
    "*Maybe I should kiss her on the cheek too?* [MonroePath] [SamanthaPath]" if Temp == 1:
        ...
        hide screen INT with dissolve1
        show screen INT with dissolve1
        "Yes, that's me. How am I seeing my self in third person? Who knows? Consider my mind blown."
...
label sgGreetPC1:
    ...
    PL "If you're the mother, than where are all my siblings?"
    SG "He, he. Right now there's three other residents living here. Maybe they can be your siblings?"
    ...
    SG "I'm really sorry to hear that [OM], maybe next time you can stay a while and we could catch up?"
    OM "It would be my pleasure Ms. Gail. That's certainly something to look forward to."
    scene ep1_SGOMlookatPC1 with dissolve
    OM "Well kid, this is it for now. I'll be back on my next scheduled visit."
    OM "Or earlier, if I get reports of any misbehaviors on your part. So watch yourself."
    OM "Remember the three strikes!" with vpunch
    scene ep1_OMgoodbye with dissolve
    show screen INT with dissolve1
    "[OM]. Out of all the correctional officers that's been involved in my case so far, amazingly he's one of the few I don't actually hate."
    "He's neither fake nor indifferent. At the very least, seems like he genuinely gives a shit."
menu:
    "*Aww what the hell, I should give the man a hug!* [MonroePath]":
        hide screen INT with dissolve1
        $ omFP += 3
        $ Temp = 1
        jump tpOMPChug
    "*I'll just shake his hand and get this over with.*":
        hide screen INT with dissolve1
        $ omFP += 1
        jump tpOMPCshake
hide screen INT with dissolve1
...
label tpOMPCshake:
    ...
    scene ep1_SGPCentrancesmile with fade1
    if Temp == 1:
...
label sg_livingroomtalk:
    ...
    EM "Is everything OK [SG]? I heard shouting."
...
hide screen INT with dissolve1
menu:
    "\"[OM] said there's some rules I have to follow?\"" if q1 == 0:
        $ q1 = 1
        jump tp_sg_rules
...
label tp_sg_rules:
    ...
    SG "As for you. I'll assign you a part time soon. It's mandatory, you have to show up everyday."
    ...
    SG "Well, sometime we get someone charged with under-aged prostitution, so STDs tests is part of the program."
    show screen INT with dissolve1
...
label tp_sg_actress:
    ...
    PL "Wow, so you really were one! Any chance I can take a look at anything you've done?"
    scene ep1_SGPClivingroom3 with dissolve
...
label tp_sg_tour:
    scene ep1_SGPClivingroomstand1 with dissolve
    ...
    SG "But I converted it to this since the dining table in the kitchen is too small to sit everybody."
    ...
    SG "Though take my advice and don't ask the other two. Ha, ha. They hate cooking duty."
...
label kitchenmeetEM:
    ...
    menu:
        "\"Sorry about how I acted before.\"":
            ...
            menu:
                "*This bitch is getting on my nerves. Fuck apologizing!* [gr](Emily Fight)":
                    hide screen INT with dissolve1
                    scene ep1_SGPCkitchenmeetEM3 with dissolve
                ...
                "*Try to apologize again and hope for the best.* [gr](Emily Apology)":
                    ...
                    PL "It just brought up a whole lot of awful memories form shit that happened."
                    scene ep1_SGPCkitchenmeetEM8 with dissolve
                    ...
                    EM "Fine. Since [SG] say it's okay. I guess it's okay with me too."
...
label emapologyfightend:
    ...
    hide screen INT with dissolve1
    play music loop6 fadein 1
    SG "Well? I hope you're proud of yourself. Acting like a couple of kids."
    PL "Me a kid? She's the one who poked her tongue out at me. What is she, five?"
    SG "He, he. Wasn't that cute?"
    SG "She's probably just embarrassed and didn't know how to act right after getting upset."
    SG "[EM] Is very protective of her friends. Sometimes even going to extremes. That's how she got into trouble in the past."
    SG "You two have a lot in common when it comes to dealing with emotions if you get right down to it..."
...
label tp_sg_tour2:
    ...
    SG "There's four rooms up there so you each get your own."
...
label ep1_SG_tour3:
    ...
    "Small, comfortable and most importantly, private!"
    "Try spending four years showering in a crowd see how you'd like it."
    hide screen INT with dissolve1
    ...
    SG "The door lock is kind of finicky. Sometimes it doesn't work right."
    ...
    "Maybe with that part time they were talking about I can get one."
    ...
    SG "Oh sure. Go ahead, as long as you don't punch holes in the walls, you can do whatever makes you comfortable."
    ...
    label ep1_SGplroomhug:
        ...
        show screen INT with dissolve1
        menu:
            "*I think I can give her a hug maybe?*":
                ...
                show screen INT with dissolve1
                menu:
                    "[gr]*This is nice! I don't want to let go.*":
                        stop music fadeout 4
                        hide screen INT with dissolve1
                        ...
                        show screen INT with dissolve1
                        menu:
                            "[gr]*I wanna try grabbing her waist next!*":
                                hide screen INT with dissolve1
                                ...
                                "I can feel her tits on me for fucks sake!"
                                "That's it! This woman's been parading it in front of me all day, she's asking for it!"
                                show screen INT with dissolve1
                                label dynamicChoice2:
                                    if sgCP >= 1 and stareassSG >= 1:
                                        $ dynamicChoice2 = gr
                                    else:
                                        $ dynamicChoice2 = red
                                        $ dynamicChoice2_2 = gr
                                menu:
                                    "[dynamicChoice2]*I just have to get a feel for dat ass!*":
                                        hide screen INT with dissolve1
                                        show ep1_SGplroom6
                                        if sgCP >= 3 and stareassSG >= 2:
                                            ...
                                            PL "No, to be honest it was never about just a simple hug from the start."
                                            ...
                                            SG "Wow, I like that fact you're not afraid to admit it."
                                            ...
                                            SG "If it were anyone else there'll be hell to pay right about now don't you think?"
                                            PL "Sorry, I think I got a little carried away with the mood and all."
                                            SG "It's fine. But you need to consider the other persons feelings too. Not just grab whatever and whenever you feel like."
                                    ...
                                    "[dynamicChoice2_2]*I need to calm the fuck down! Don't wanna do this.*" if disable == 1:
                                        stop music fadeout 4
                                        hide screen INT with dissolve1
                                        jump ep1_SGplroomhugdone
...
label ep1_SGplroomhugdonesexy:
    ...
    SG "Seems we both learned just a tiny bit more about each other, didn't we."
...
label ep1_SGplroomhugdone:
    scene ep1_SGplroom1 with dissolve
    SG "I'm leaving. See you later and dinner time."
...
label ep1_PCplroom1:
    ...
    if Temp == 1:
        ...
        "My first day and I already fucked up. [OM] is gonna cart me off back to juvie if I make anymore stupid decisions like that."
        play music inner fadein 1
    ...
    window hide
    stop music fadeout 1
    centered "{size=50}{cps=10}...{/cps}{/size}{w=1.5}{nw}"
    play sound mgs
    ...
    "Why the hell do I slobber all over my self in my sleep? Am I a dog?"
...
label ep1_ASreversestrip:
    ...
    AS "Or maybe, do my laundry? Hmmm, I can't choose which.."
    ...
    "I can see her butt hole for god's sake!"
    hide screen INT with dissolve1
    ...
    PL "Now that you mentioned it, I'm more worried about [EM] to be honest."
    ...
    AS "She's kinda like a guard dog. They don't really trust anyone until you let em' sniff your butt a few dozen times."
    ...
    AS "I'd offer to shake your hands or something but from the looks of you, I don't think you can handle touching me anywhere right now."
    show screen INT with dissolve1
    ...
    "Still need to wash my face and hurry down stairs."
    ...
    hide screen INT with dissolve1
    scene ep1_SGEMASdinner0 with fade
    show screen INT with dissolve1
    ...
    PL "No ma'am, went to wash my face and ran into [AS], so we got to talking."
    EM "Oh, but then where is she? Why isn't she down yet?"
    ...
    EM "It clearly says to knock make sure nobody's inside first since the lock's broken."
    ...
    scene ep1_SGEMASdinner1a with dissolve
    EM "Then what? I suppose being the upstanding gentleman that you are, you apologized and immediately left right?"
    PL "{cps=10}....{/cps}{nw}{w=1}"
    scene ep1_SGEMASdinner1c with dissolve
    play sound punch1
    EM "Hey!{fast}" with vpunch
    scene ep1_SGEMASdinner1 with dissolve
    PL "Well... she kinda invited me in and we, ahhh, talked?"
    PL "What was I supposed to do? I needed to wash my face anyway and [AS] seems okay with it, she wasn't even the least bit put out."
    ...
    show screen tip(message= "Tip: This next choice is a branching path point. Check Readme screen for more info.")
    menu:
        "*Unvarnished Truth: Tell her every detail.* [gr](Emily Truth)":
            hide screen INT with dissolve1
            ...
            EM "The only difference is for whatever reasons [AS] didn't get mad at you."
            ...
            PL "Well, ummm... she kinda put her hand somewhere..."
            ...
            hide screen INT with dissolve1
            PL "Yeah nothing happened but I won't lie, I did kinda enjoyed what I saw. But..."
            $ toldEMaboutASbath = 1
            menu:
                "\"I'd enjoy it more if it were you though.\"":
                    ...
                    show screen INT with dissolve1
                    "Is it just me or does she looks a little happy despite this little act?"
                    ...
                    if apologyEM == 1:
                        ...
                        scene ep1_SGEMASdinner1a with dissolve
                        EM "Oh before I forget, remember how you were mean to me before and refuse to apologize?"
                        ...
                        jump ep1_EMdinnerdone
        "*Half Truth: Just omit the lewd parts.* [gr](Emily Secret)":
            ...
            scene ep1_SGEMASdinner1b with dissolve
            EM "Humph! And I bet you were enjoying looking at her every minute of it!"
            PL "Hey, I'm a guy and [AS] is a pretty girl. What's not to enjoy? Doesn't makes me a pervert, it's natural."
            scene ep1_SGEMASdinner1 with dissolve
            EM "Natural my butt. You're just like [LU]. Natural lecher is more like it."
            EM "The only difference is for whatever reasons [AS] didn't get mad at you."
            EM "I think that girl is being an idiot. You should treat all perverts the same!"
            ...
            menu:
                "\"I'd enjoy it more if it were you though.\"":
                    ...
                    if apologyEM == 1:
                        scene ep1_SGEMASdinner1 with dissolve
                        EM "Oh before I forget. I wanted to say I'm sorry for the way I reacted earlier when we first met."
                        EM "I seriously thought you were a jerk at first but you actually tried really hard to apologize to me."
                        EM "I appreciate it. So to make it up to you I've tried to make dinner extra special tonight!"
                        jump ep1_EMdinnerdone
                    else:
...
label ep1_EMdinnerdone:
    ...
    AS "Oh, so [EM] was right after all. We're you like, part of a gang or something?"
    ...
    AS "Boringggg."
    show screen INT with dissolve1
    "Yep, I was right. This girl's a nut-case."
...
label ep1_dinnerquestion:
    menu:
        "\"What about you [AS]? What were you in for?\"" if q1 == 0:
            ...
            AS "It was shady as fuck, they cater to all kinds of kinks, even those looking for under-aged ones."
            AS "You'd be surprised how many old fogies out there are dreaming about fucking highschoolers."
            show screen INT with dissolve1
            ...
            AS "I remember this one guy doing crazy shit with his tongue."
            ...
            SG "That's enough [AS]."
            SG "I don't mind you telling [PL] about your past, but try not to be too literal in your description please."
            ...
            AS "The scandal made them start up a big time investigation and that big time investigation exposed the under-aged thing."
            ...
            menu:
                "*Ask her is she's still having sex for money.*":
                    ...
                    stop music fadeout 4
                "*On second thought, it is stupid. Better not.*":
                    scene ep1_SGEMASdinner11d with dissolve
                    hide screen INT with dissolve1
                    PL "No, I'm good."
        ...
        "\"I want to talk about what happened to you [EM].\"" if q2 == 0:
            ...
            if apologyEM == 1:
                EM "Sure [PL], I can tell you a little about what happened to me in the past."
            else:
                EM "Fine. You sure are nosy, but I can tell you a bit if you really must know."
            play music dark fadein 1
            scene ep1_SGEMASdinner12d with dissolve
            EM "I had a friend in school. She's a nice girl but kinda quiet and not very out going."
            ...
            menu:
                "Paid for it? Paid for what? What'd you do?":
                    scene ep1_SGEMASdinner12j with dissolve
                    AS "Ha! What didn't she do? You think you're a bad-ass?"
                    ...
                    "I've seen those shoes before man. Some of em are covered with eight inch spikes!"
                    hide screen INT with dissolve1
                    scene ep1_SGEMASdinner12i with dissolve
                    menu:
                        "\"I'm with [AS], that bunch deserved it.\" [EmilyPath]":
                            scene ep1_SGEMASdinner12j with dissolve
                            AS "Right?"
                            scene ep1_SGEMASdinner12h with dissolve
                            ...
                            scene ep1_SGEMASdinner12i with dissolve
                            menu:
                                "\"So whatever happened to your friend in the end.\" [EmilyPath]":
                                    scene ep1_SGEMASdinner12m with dissolve
                        ...
                        "\"I think you went a bit overboard.\"":
                            ...
                            scene ep1_SGEMASdinner12i with dissolve
                            menu:
                                "\"So whatever happened to your friend in the end.\"":
                                    scene ep1_SGEMASdinner12m with dissolve
                                    EM "We kinda lost touch after that."
                                    EM "I heard from my mom that their entire family moved somewhere overseas."
                                    scene ep1_SGEMASdinner12n with dissolve
...
label ep1_dinnerquestiondone:
    ...
    scene black with irisin
    window hide
    centered "{size=50}{cps=10}Sometime Later...{/cps}{/size}{w=2}{nw}"
...
label ep1_dinnerundertabledone:
    ...
    "Wow, everything's pretty much gone. These girls sure can eat, who said women can't pack it in?"
    ...
    PL "I never would've guessed [EM] is such a bad-ass."
    ...
    hide screen INT with dissolve1
    menu:
        "\"I was wondering if you maybe want some help?\" [EmilyPath]":
            $ emLP += 1
        ...
        "\"Nah, it's nothing. I'm pretty tired so I'm gonna go to bed.\"":
...
label ep1_EMkitchenhelppan:
    ...
    menu:
        "*Stupidly stare at her for a while*.":
            hide screen INT with dissolve1
    ...
    menu:
        "\"Looking at you. You're really cute you know?\" [EmilyPath]":
            ...
            label ep1_EMkitchenhelpboobs:
                if _in_replay:
                    ...
                    $ disable = 1
            menu:
                "\"In fact, I'll ogle your boobs anytime you like.\" [EmilyCorruptionPath]":
                ...
                "\"Trust me, you're a cute girl. And nice to boot.\" [EmilyLovePath]" if disable == 1:
                    ...
                    $ emLP += 3
                    $ starepromiseEM = 0
        "\"Ummm... Nothing, I should hurry up to bed.\"":
...
label ep1_PCplroomb:
    ...
    if apologyEM == 0:
        ...
        label ep1_PCEMapologypan:
            ...
            show screen INT with dissolve1
            "Wow, now that's what I call sleep wear."
            ...
            show screen INT with dissolve1
            menu:
                "*Might as well take this chance to look around.*":
                ...
                "*Let's just get this over with and apologize.*":
                    hide screen INT with dissolve1
                    PL "So, ummmm....."
            hide screen INT with dissolve1
            ...
            EM "It's fine you don't have to worry about that anymore. I've already decided that you're not such big a jerk."
            ...
            hide screen INT with dissolve1
            menu:
                "*Tell her exactly what I think.* [EmilyPath]":
                    ...
                    $ emCP += 1
                    jump ep1_PLEMroom1
                "*Nah, can't let her know she's getting to me.*":
                    jump ep1_PLEMroom1
...
label ep1_LUPCplroom:
    ...
    menu:
        "*Better see who the hell it is.*":
            ...
            show screen INT with dissolve1
            menu:
                "*Better do as he says. The guy seems insane.* [LuisPath]":
                    hide screen INT with dissolve1
                    scene black with irisin
                    centered "{size=50}After a short but embarrassing time...{/size}{w=1.5}{nw}"
                ...
                "*This guy's an idiot if he thinks I'd do all that.* [LuisPath]":
                    ...
                    scene black with irisin
                    play sound beatdown
                    centered "{size=50}After a short time wrestling on the floor...{/size}{w=2}{nw}"
                    scene ep1_LUplroom2 with irisout
                    AS "SHUT UP! IDIOTS!" with dpunch
                    AS "I'm trying to sleep!"
                    scene ep1_LUplroom2a with dissolve
...
label ep1_LUPCplroom2:
    ...
    LU "I'd really would've made it if I could."
    PL "{cps=10}....{/cps}{nw}{w=1}"
    ...
    LU "I can show you around town, introduce the best spots for some fun."
    scene ep1_LUplroom5 with dissolve
    LU "This place might look like the ass end of nowhere at first glance."
    scene ep1_LUplroom4 with dissolve
    LU "But the next town over has a banging night life."
    LU "It's been a while since you've been anywhere right?"
    scene ep1_LUplroom7 with dissolve
    ...
    LU "Took a while to actually find him but when I finally did. Beat the fucker half dead."
    PL "{cps=10}....{/cps}"
    PL "You got three years for beating up a fucking low life?"
    ...
    LU "They didn't join in the beat down but they did help clean out the place."
    scene ep1_LUplroom3 with dissolve
    ...
    scene ep1_LUplroom3 with dissolve
    LU "Ha, ha. Chill bro. I got ways around that shit. You'll see."
    PL "{cps=10}....{/cps}{nw}{w=1}"
    show screen INT with dissolve1
    ...
    scene ep1_LUplroom8 with dissolve
    LU "Except for me! Shit! I mean I've been here longer that she has and she's still on my case half the time."
    PL "Ha, ha. Yeah I get that. She kinda talks shit about you non stop."
