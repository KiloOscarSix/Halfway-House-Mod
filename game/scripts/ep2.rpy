...
label ep2_ASplroommorningsex:
    ...
    if toldEMaboutASbath == 1:
        ...
        menu:
            "[gr]*Open my eyes and have a look.*" if True:
                stop sound
                ...
                label ep2_ASplroomjump:
                    ...
                    AS "Because of you, I just had to spend forever listening to one of [EM]'s never-ending tirades."
                    show screen INT with dissolve1
                    "Ahhh fuck! I knew this was gonna come back to bite me in the ass."
                    hide screen INT with dissolve1
                    scene ep2_ASplroom5 with dissolve
                    ...
                    menu:
                        "*Is she really serious about this?*" if True:
                            hide screen INT with dissolve1
                            scene ep2_ASplroom7 with dissolve
                                ...
                                label ep2_ASplroomsexmenu:
                                    ...
                                    menu:
                                        ...
                                        "\"Can you at least use your hands?\"" if q1 and q2 == 1:
                                            ...
                                            hide screen INT with dissolve1
                                            menu:
                                                "[gr]\"Okay. But, how about losing those clothes for me?\"" if True:
                                                    ...
                                                    "Totally different from jacking off to the same porn mag every day."
                                                    ...
                                                    menu:
                                                        "*Stop fighting it and mess up her face.* [blue](Facial)" if True:
                                                            hide screen INT with dissolve1
                                                            ...
                                                            AS "Please don't tell me this is normal for you."
                                                            scene ep2_ASplroom39 with dissolve
                                                            ...
                                                            AS "{cps=10}....{/cps}"
                                                            scene ep2_ASplroom40 with dissolve
                                                            AS "I'm not the blabbermouth here, moron! You are!"
                                                        ...
                                                        "*Stop jerking off and make her keep her word.* [blue](Forced BJ + Swallow)" if True:
                                                            hide screen INT with dissolve1
                                                            scene ep2_ASplroom35a with dissolve
                                                            ...
                                                            show screen INT with dissolve1
                                                            menu:
                                                                "*Push her head down and fill her up.*" if True:
                                                                    hide screen INT with dissolve1
                                                                    ...
                                                                    PL "The spunky girl with a mouth-load of spunk! Ha ha ha!"
                                                                    scene ep2_ASplroom45 with dissolve
                                                                    ...
                                                                    $ renpy.end_replay()
                                                                    jump ep2_ASplroomsexdone
                        "*I don't like the way she's bossing me around!*" if True:
                            ...
                            AS "That's it, play time's over!"
                            jump ep2_ASplroomjump2
            "*Ignore it. Hope it goes away.*" if True:
    ...
    label ep2_EMhallway:
        ...
        show screen INT with dissolve1
        menu:
            "*Tease her a bit.* [EmilyPath]" if True:
                hide screen INT with dissolve1
                scene ep2_EMhallway8 with dissolve
                ...
                if ep1_EMnightvisit == True:
                    ...
                    PL "Now it's clear as day and I'm seeing it in all its skimpy glory. Ha ha."
                    scene ep2_EMhallway11 with dissolve
                    EM "{cps=10}....{/cps}"
                $ emCP += 2
                jump ep2_EMhallway2
            "*Nah, I'm in a hurry.*" if True:
                hide screen INT with dissolve1
                jump ep2_EMhallway2
    ...
    label ep2_EMhallway2:
        ...
        show screen INT with dissolve1
        menu:
            "*That's sweet. Tease her a bit more.* [EmilyPath]" if True:
                hide screen INT with dissolve1
                ...
                $ emLP += 2
                jump ep2_EMhallway3
            "*It's her choice if she likes being a maid.*" if True:
                hide screen INT with dissolve1
                jump ep2_EMhallway3
...
label ep2_EMSGkitchen:
    if ep2_ASmorningforeplay == 1:
        ...
        menu:
            "*Compliment/Tease her.* [EmilyPath]" if True:
                hide screen INT with dissolve1
                scene ep2_EMSGkitchen6 with dissolve
                PL "Man, you'd make someone a perfect wife one day."
                ...
                EM "You should scold him instead of just standing there laughing!"
            ...
            "*Nah, it'll go the her head." if True:
                hide screen INT with dissolve1
                jump ep2_EMSGkitchen1
    elif True:
...
label ep2_EMSGkitchen1:
    ...
    SG "My pleasure, [PL]."
    SG "Don't expect this every day though. You'll have to start learning to do things yourself, remember?"
    ...
    if sgCP >= 5:
        ...
        menu:
            "*Flirt back a little.* [SamanthaPath]" if True:
                hide screen INT with dissolve1
                scene ep2_EMSGkitchen27 with dissolve
                ...
                EM "Acting like a couple of high-schoolers on prom night..."
                ...
                play sound dishes
                window hide
                centered "{size=35}{cps=20}Sometime later...{/cps}{/size}{w=2.5}{nw}{nw}"
                jump ep2_EMSGkitchen2
            "*I can't do that while [EM]'s around.*" if True:
                hide screen INT with dissolve1
...
label ep2_EMSGkitchen2:
    ...
    "Wouldn't it be great if I could get her to make this for me every day?"
    ...
    SG "Cleaning, doing the heavy lifting, that kind of thing."
    SG "If you're smart, maybe you'll pick up a thing or two while working with him."
    scene ep2_EMSGkitchen25 with dissolve
    PL "So he won't even be training me or anything?"
    scene ep2_EMSGkitchen24 with dissolve
    ...
    EM "{cps=10}....{/cps}"
    scene ep2_EMSGkitchen25 with dissolve
    PL "Wow, everyone's job seems rather normal so far."
    ...
    AS "Nice? That's it? They are works of art, dude!"
    ...
    SG "You see... [AS] was actually supposed to work at the library at first..."
    ...
    SG "I figured that if anyone could handle our little troublemaker, it would be her."
    ...
    scene ep2_EMASSGkitchen9 with dissolve
    AS "A hardcore gangbanger like you needs some ink on that pasty skin of yours."
    scene ep2_EMASSGkitchen5 with dissolve
    ...
    "Should I try asking?"
    menu:
        "*Not in front of everyone.*" if True:
            hide screen INT with dissolve1
            scene ep2_EMASSGkitchen6 with dissolve
        ...
        "*Fuck, let's just ask her.*" if True:
...
label ep2_EMASSGtattoodone:
    ...
    stop music fadeout 4
    menu:
        "*Let's go take a cold shower*" if True:
            hide screen INT with dissolve1
            play sound steps
            jump ep2_PCbathroom
...
label ep2_PCbathroom:
    ...
    menu:
        "*Let's test this sucker out!*" if True:
            ...
            if ep2_ASmorningforeplay == 0:
                ...
                hide screen INT with dissolve1
                menu:
                    "*Time to take care of business.*" if True:
                        scene ep2_PCbathroom6 with dissolve
                        show screen INT with dissolve1
                        "{cps=10}....{/cps}"
                        "Shit! This isn't working."
                        "I need to think of good fap material."
        ...
        menu:
            "[gr]\"What's not to like?\"" if True:
                ...
                if sgCP >= 10:
                    ...
                    hide screen INT with dissolve1
                    menu:
                        "\"How about just once more?\" [SamanthaPath]" if True:
                            scene ep2_SGbedroomhallway4 with dissolve
                    ...
                    hide screen c_fail
                    SG "He he, why not? It's not like I'll lose anything if it all happens in your head..."
                    SG "So, knock yourself out."
                    PL "{cps=10}....{/cps}"
...
label ep2_SGgarage:
    ...
    SG "You didn't really expect me to be the one sending each of you kids to work every day, did you?"
    ...
    SG "Ha ha."
    SG "Anyway, even if I wanted to drive you kids around every day..."
    SG "My car can't really fit more than two people comfortably..."
    scene ep2_SGgarage6 with c_male
    SG "...as you can see."
    PL "Wow!" with vpunch
    PL "That's your car?"
    scene ep2_SGgarage7 with fade
    PL "Seriously?"
    ...
    PL "I think I died and gone to heaven."
    ...
    if sgCP >= 14:
        ...
        PL "But right now the Porsche edges you out just a little bit."
...
label ep2_SGdrive:
    ...
    stop music fadeout 4
    play sound driveby
    centered "{size=35}{cps=20}After some small talk and a nice drive...{/cps}{/size}{w=2.5}{nw}"
...
label ep2_SGworkshop:
    ...
    EL "Nothing wrong with your Porsche, I hope."
...
label ep2_SGworkshopa:
    ...
    scene ep2_SGworkshop23 with dissolve
    EL "After he passed on, Sam's mom only wanted simple, no strings relationships when it came to men."
    ...
    scene ep2_SGworkshop23 with dissolve
    EL "For you maybe!"
    EL "But now's not the time to be jabbering nonsense. We got more important things to talk about."
    scene ep2_SGworkshop21 with dissolve
    PL "Like what?"
    scene ep2_SGworkshop19 with dissolve
    ...
    EL "Fair fight?"
    scene ep2_SGworkshop21 with dissolve
    PL "Started that way, but I grabbed a weapon at the tail end of it."
    scene ep2_SGworkshop25 with dissolve
    EL "Hmmm... what kinda weapon? Knife? Did you go and stab someone?"
    scene ep2_SGworkshop21 with dissolve
                ...
                menu:
                    "*No, not yet. Gotta wait for the right timing!*" if disable == 1:
                        ...
                        label ep2_SGworkshopfightcont:
                            ...
                            SG "Arghhhh!"
                            UN "Shush... Don't be scared, sweetheart."
                            ...
                            $ renpy.end_replay()
                            menu:
                                "*Time to murder this fucking scum!*" if True:
                                    hide screen INT with dissolve1
                                    play sound punch1
                                        ...
                                        "*Crawl away.*" if True:
                                            ...
                                            menu:
                                                "*Get up.*" if True:
                                                    ...
                                                    menu:
                                                        "*Start combo-ing this idiot*" if True:
                                                                ...
                                                                "*Second hit.*" if True:
                                                                    ...
                                                                    menu:
                                                                        "*Third hit.*" if True:
                                                                            ...
                                                                            UN "We'll gangbang the shit outta her!"
                                                                            UN "HA HA HA HA!"
                                                                            ...
                                                                            show screen INT with dissolve1
                                                                            "Damn..."
                                                                            "Whatever happened to being against violence?"
                                                                            "Good for you, [SG]."
                                                                            ...
                                                                            PL "Yeah... he got me in the arm and bashed my head in pretty good too."
                    ...
                    "[gr]*Grab his arm and punch his face in!*" if q1 == 0:
                        hide screen INT with dissolve1
