...
if sgCP >= 26:
    ...
    "I mean, I came all over her back! It's amazing she even let me do that. I guess getting hurt trying to help her out has its perks."
    ...
    label ep5_SGthoughtpass:
        ...
        PL "Ah, fuck it, let's just man up and bear with it..."
        ...
        PL "He he, but before that, let's check out [EM]'s browsing habits! Maybe she's into some super kinky porn or something!"
        scene ep5_plroom13 with dissolve
        PL "Shit, there's tons and tons of Metube vids, and it's all about funny shit people get up to."
        ...
        PL "Yeah... I'm not buying it! She must've covered up her pervy little tracks!"
        ...
        PL "\"Why do guys think it's cute when a girl is mad.\""
        PL "{cps=10}....{/cps}{nw}{w=1.5}"
        ...
        PL "There's a bunch of Facelog searches too. Let's have a look."
        ...
        menu:
            "*Look for any pics of [EM].*" if True:
                ...
                pause
                PL "Whoa, close one. Lucky you didn't smash face first into that trophy case."
                ...
                PL "All I keep thinking are perverted thoughts!"
                ...
                pause
                PL "Oooh, she's outside now doing her stretches."
                ...
                PL "I wonder if something like this is popular with schoolgirls or something. [EM] did the exact same one before too."
                scene ep5_plroom51 with dissolve
                PL "Oh shit, something's up. Maybe it's a teacher or something."
                ...
                PL "Hmmm. I think I may have just found the elusive Julie. I don't have any real proof, but my gut feeling tells me she's the one."
                ...
                PL "They sure look real nice together. Shame they've lost touch. I really ought to try to find some info on this girl."
...
label ep5_LUroom:
    ...
    menu:
        "*Yeah... the big lunk can wait a bit.*" if True:
            ...
            LU "Mmmghhhhhh..."
            PL "You know, I was thinking about this at the hospital. Maybe you can show me how to work out and shit. I need to get built too, man."
            ...
            LU "HA HA HA, bet you're jealous, right? I doubt she'd do something like this just for anyone! Guess she doesn't really hate me despite the act."
            ...
            LU "Now, if you're done looking at it, put it back. That thing is my treasure. I'm gonna get real mad if you break it or leave any dirty fingerprints on it."
            ...
            $ luFP += 2
        "*Let's just get straight to the point." if True:
...
label ep5_LUroom1:
    ...
    menu:
        "*I'm sure I can trust [LU] not to judge me.* [LuisPath]" if True:
            hide screen INT with dissolve1
            scene ep5_LUroom32 with dissolve
            ...
            PL "And last night she lent me her laptop for some reason. Guess she was just being extra nice coz of me getting hurt and all."
            ...
            PL "Ummm... {w=1}sure, I don't mind. {w=1}It's just that... ummm.... {w=1}that girl's picture ain't the only ones I'm looking to get."
            ...
            play sound steps
            $ luFP += 2
        "*No! I'll get teased for wanting those sexy pics!*" if True:
...
label ep5_LUplroom:
    ...
    LU "Pffft.... {w=1}I could do that easy... but I ain't gonna."
    ...
    LU "Hmmm... {w=1}you know what? I can see why you'd be interested in this. I mean, it's really wedged up in there. You can see almost everything."
...
label ep5_EMpcdone:
    ...
    PL "But first, let's at least put some pants on. Don't wanna walk around with my undies showing."
    label ep5_PLdressmenu:
        menu:
            "*Get decent and head downstairs.*" if True:
...
label ep5_SGsearch:
    ...
    $ renpy.pause (delay=1.5)
    PL "Hmmm...{w=1} maybe she's still in her room sleeping?"
    ...
    menu:
        "*Knock on the door.*" if True:
            ...
            menu:
                "[gr]*Go inside and check.*" if True:
                    play sound dooropen
                    ...
                    PL "Who knows? She could be unconscious in the bathtub or something..."
                    PL "So as a responsible resident of this here halfway house, it's my duty to make sure."
                    PL "Getting to see her naked this early in the day has absolutely nothing to do with it!"
                    ...
                    stop music fadeout 4
                    $ ep5_SGroomcheck = 1
                "*Nah, I should go look somewhere else.*" if True:
...
label ep5_SGsearchbackyard:
    ...
    SG "Hey, [PL], good morning... What time is it? Looks like it's already past noon."
    ...
    SG "So, [PL], why did you come looking for me? Ha ha, it's not because you're lonely, is it?"
    SG "Waking up and finding the house empty made you a little panicky maybe?"
    PL "{cps=10}....{/cps}"
    hide screen r_unlock
    play music loop6 fadein 1
    ...
    $ renpy.pause (delay=1)
    show screen INT with dissolve1
    "Shit, must've been [AS]. I doubt [EM] would be mean enough to eat my food and leave me hanging..."
    "Probably did it out of spite or something."
    hide screen INT with dissolve
    ...
    SG "Sigh... {w=1}I can't believe those girls finished up everything. I made a pretty big breakfast!"
    SG "I'm going to give whoever it is that did that a good talking to when they get back!"
...
label ep5_SGkitchen:
    ...
    SG "Hmmm... {w=1}how about a cold cut sandwich? I think we have everything for something like that."
...
label ep5_SGfridgepan:
    ...
    SG "You said you're starving, right? Well, let's see if you can finish this. I made a bigger than normal portion just for you."
    ...
    if sgCP >= 24:
        ...
        "But she's acting like everything's normal. That's not right... Not after what happened..."
        ...
        PL "If that's the case, it's still not good, is it? I just wanna know where we stand right now."
        PL "You want me to act like nothing happened? I don't think I can do that."
        ...
        "Well, this is something out of the ordinary, I suppose. She's old enough to be my mom, not to mention the fact that she's one of the people monitoring my probation."
        "{cps=10}....{/cps}"
        "I could just keep quiet and let this go for now... or try to convince her we did nothing wrong maybe?"
        menu:
            "*Convince her.* [SamanthaPath]" if True:
                hide screen INT with dissolve1
                scene ep5_SGPLkitchen26 with fade
                PL "Sorry, [SG], I wouldn't have brought it up if I knew this was bothering you this much."
                PL "I guess I let my expectations get the better of me. Sorry..."
                PL "You're asking yourself, \"What am I doing?\" Well, in my opinion, you're just being you, [SG]."
                PL "That's who you are first and foremost."
                PL "Everything else, like running this halfway house, being a surrogate mother to everyone and your age, that's all secondary."
                scene ep5_SGPLkitchen36 with dissolve
                PL "It was [SG] that did the flirting, the sexy stuff, and what happened last night."
                PL "I don't see what's so wrong about being true to yourself. I like that about you."
                ...
                PL "That aside though, you get what I'm saying, right? I don't think you should be so hung up about this."
                PL "As long as it stays just between us for now, I think it'll be alright."
                scene ep5_SGPLkitchen37 with dissolve
                SG "Sigh... {w=1} I guess so. I don't know why I'm beating myself up over this just now."
                SG "It was my own behavior that led up to all this, and it wasn't like you forced me into anything."
                SG "But, even so, things are moving just a little too fast for me. Especially after last night."
                SG "We both need to step back a bit from this and regain some normalcy."
            ...
            "*Let it go.*" if True:
                hide screen INT with dissolve1
                PL "Sorry, [SG], I wouldn't have brought it up if I knew this was bothering you this much. I guess I let my expectations get the better of me. Sorry."
    ...
    PL "Since you let me sleep in, I assume I don't have to go to Eli's yet?"
    hide screen c_fail
    play music loop fadein 1
    scene ep5_SGPLkitchen21 with dissolve
    ...
    SG "Just don't stay cooped up in your room all day. You can hangout in the living room or go get some sun in the yard."
    SG "It's a nice day out... Or, better yet, go take a walk outside."
    if ep5_SGroomcheck == 1:
        ...
        PL "When's that from anyway? And where? You weren't out on a date or something, right? It looked recent so it couldn't have been from when you were dating that rich guy."
        scene ep5_SGPLkitchen29 with dissolve
        SG "Ha ha ha, slow down!"
        SG "That was from a few months ago. It was out in front of a bar in town, and you're half right. I was all dressed up for a meetup, but It wasn't a proper date."
        SG "It was all because of [NA] and Liz. It was all their doing."
        SG "They found the guy, convinced me to have a drink with him, dressed me in that outfit, and set up an ambush in front of the meeting place to spy on me."
        ...
        SG "They've been on my case for months about how I've gone dateless for so long, so they set all that up."
        SG "I just went along with it because I couldn't stand their nagging anymore."
        scene ep5_SGPLkitchen30 with dissolve
        PL "Oh, that sounds nice. So how was it? Did you like the guy? And ummm... {w=1}was there any follow-up dates after?"
        ...
        if sgCP >= 24:
            ...
            SG "{cps=10}....{/cps}"
            scene ep5_SGPLkitchen29 with dissolve
            SG "You want me to wear that dress for you? That's not the kind of everyday outfit you wear while running around doing errands."
            PL "That's not exactly what I had in mind... I was thinking more like a night out. Just the two of us. Like with that guy you got set up with."
    ...
    SG "How about a bath instead? You can use my tub for the time being. Just until you get better, mind you. I don't just let anyone use my bath."
    ...
    SG "Awww... why?"
    $ quick_menu = False
    centered "{size=35}{cps=20}After finishing up your breakfast...{/cps}{/size}{w=2.5}{nw}"
...
label ep5_SGbathroom:
    ...
    if ep5_SGroomcheck == 1:
        ...
        SG "About the only one that comes in here regularly is [EM]. Even then, it's only to pick up the laundry basket."
        menu:
            "*Look around." if True:
                ...
                SG "That portrait? Oh, that's just a picture of me on a night out. [NA] and Liz took it. I thought it looked kinda nice... like I was a movie star or something."
    ...
    PL "Yeah, sure, [SG], whatever you say... {w=1}Plus, I don't really have the urge to take a dump right now anyway.{nw}{w=3}"
    scene ep5_SGPLbathroom13 with dissolve
    SG "[PL]!" with vpunch
    ...
    PL "I should take it off and check out the scar, maybe? Kinda curious to see what it's like. Must make me look mean. Like some sort of badass."
    ...
    SG "That's just about the stupidest thing I've ever heard. Why would you risk making your injuries worse for something so idiotic?"
    SG "You just had those stitches done a couple of days ago."
    SG "You're not supposed to uncover them just to have a look!"
    SG "And scars do not make you look tough! In fact, I really hope you don't have much of a scar at all."
    ...
    PL "Ahhh... damnit, [SG], not this again... {w=1}We already decided what happened wasn't your fault, remember?!"
    ...
    menu:
        "*Get butt naked and climb in.*" if True:
            stop music fadeout 4
            ...
            SG "Of course you are. I haven't put in anything yet. I'll do it right now."
            if sgCP >= 26:
            ...
            SG "I'm not looking, I'm not looking! Calm down!"
            SG "This is a surprise. I wouldn't have expected you to be so shy about these kinds of things with the way you've been acting towards the ladies."
            ...
            SG "For now, yes... but I suggest lathering up and washing yourself a little bit later."
            SG "Don't forget the hard to reach places. Just be careful with your arm and don't get your head wet."
            PL "Sure, [SG]."
            PL "{cps=10}....{/cps}"
            PL "Ummm... {w=1}aren't you leaving?"
            scene ep5_SGPLbathroom42 with dissolve
            SG "Hmmm... {w=1}you know what? I think I'll keep you company. We can talk a little bit, and I can keep an eye on you too."
            PL "Wait, what? You don't have to do that! I'm not a little kid. I can take a bath alone without drowning myself!"
            SG "Shush! You don't have any choice in the matter. I'm staying and that's final."
            ...
            SG "It's fine that the ladies run around half naked in skimpy clothing, but you can't even sit in a bathtub without kicking up a fuss?"
            PL "{cps=10}....{/cps}"
            ...
            SG "Hmmm... {w=1}how about you tell me a little bit about your family?"
            SG "I know you're an only child, but what's your relationship with your parents like?"
            PL "Do I really have to talk about them? Plus, don't you already know everything from reading my files?"
            SG "I know the basics, but I'd rather hear it from you. It's part of the program so, yes, you have to."
            ...
            SG "Consider yourself lucky then. I don't do this for just anyone."
            scene ep5_SGPLbathroom49 with dissolve
            PL "Well... I don't know what else to tell you that you don't already know."
            PL "My dad is a loser. A major league one. He barely works, drinks all the time, and beat on my mom and me when he was wasted."
            PL "...which is pretty much all the damn time."
            PL "He wasn't always like that. I remember him being a rather decent father when I was a little kid."
            PL "But after his company folded, he turned into the shitbag he is now."
            PL "I don't know why my mom put up with him. If I were her, I'd have left that deadbeat when the abuse started..."
            PL "But she always defends his actions no matter what."
            PL "Which is why as soon as I was in high school, I was almost never at home."
            PL "Just run the streets after school with my friends and didn't get home till they were both asleep."
            scene ep5_SGPLbathroom50 with dissolve
            SG "Speaking of the school, why didn't they bring up the abuse with the authorities?"
            SG "Or your other family members? Like your aunts or uncles? Didn't they know about any of this?"
            ...
            PL "So, yeah, since I couldn't do anything about it, I just decided to avoid it all as much as I could."
            PL "Hardly spent any time at home. Just went back when it was time to sleep."
            ...
            PL "No visits from either the old man or my mom. Got some letters from her a few times though."
            PL "Other than that, no, I have no idea how they're doing or what they're up to."
            SG "Aren't you curious? I can make some inquiries if you want."
            PL "Don't bother, [SG]. I'm thinking of just striking out on my own after I'm done with my probation."
            ...
            PL "Yeah... no, thanks. Don't think I'm ready to forgive and forget just yet."
            PL "And as for my mom, while she's not on my shit list like my dad is, we're not exactly close either."
            PL "Kinda lost my common ground with her a little while after dad started falling apart."
            PL "I was like, \"C'mon Mom! Whose side are you gonna take? Mine or his?\"."
            ...
            scene black with fade1
            stop music fadeout 4
            centered "{size=35}{cps=20}After a bit of half-hearted scrubbing...{/cps}{/size}{w=2.5}{nw}"
            ...
            label ep5_SGdressingtable:
                ...
                SG "Sigh... {w=1}Fine. Thank you for the compliment... but, if you're done, go upstairs and get dressed."
                SG "I need to get ready too. It's getting rather late."
...
label ep5_PLroomb:
    ...
    scene black with fade
    PL "{cps=10}....{/cps}"
    PL "Uhhhf... {w=1}Well, that wasn't so bad."
    ...
    PL "She did go through the trouble of lending it to me and I haven't done anything with it except snoop around."
    ...
    PL "Welp, let's just go with the ol' standby for when you got nothing at all to do."
    ...
    PL "Ummm.... yeah. More importantly, [SG], that's some dress! Are you going out on a date? That sure looks like a date outfit to me."
...
label ep5_EMASlivingroom:
    ...
    $ quick_menu = False
    centered "{size=35}{cps=20}You spend the next few hours being really bad at the game... You blame it on your injuries.{/cps}{/size}{w=2.5}{nw}"
    scene ep5_EMASlivingroom7 with dissolve
    $ quick_menu = True
    PL "ARGHHH!!!" with vpunch
    PL "That's it! I fucking quit! Stupid goddamn game! You're lucky I got one arm broken, otherwise I would've beaten your ass without dying even once!"
    AS "Stop screaming at nothing like a lunatic, you idiot! Don't blame the game just coz you suck at it! It's embarrassing to watch."
    EM "Pffft... I don't know, I think it's kinda funny... ah ha ha."
    ...
    play sound thud
    AS "HEY!" with vpunch
    AS "What are you telling him all that for, miss blabbermouth?"
    ...
    play sound gasp
    EM "!!!{fast}"
    EM "Ummm... I'm gonna go up to my room and put away my things!"
    ...
    EM "And ummm.... {w=1} I need to visit the little girl's room too."
        ...
        "[gr]*Stare at it.*" if True:
            ...
            label ep5_ASbuttplay:
                ...
                if ep2_ASmorningforeplay == 1 and asCP >= 24:
                    ...
                    play sound thud
                    PL "Arghhh!{nw}{w=1.5}" with vpunch
                    scene ep5_EMASlivingroom21 with dissolve
                    ...
                    PL "You seriously want me to be honest and risk pissing you off while you have your foot jammed up my crotch?"
                    ...
                    $ renpy.pause (delay=2)
                    show screen INT with dissolve1
                    "Sigh... I never know what this crazy lady will come up with next. Well, whatever. Let's give this some thought..."
                    ...
                    "Hmmm... {w=1} Wait, that's not very indicative of her actual tush. Those tight pants are constricting it."
                    ...
                    label ep5_ASbuttmenu:
                        menu:
                            ...
                            "*Choose [AS].* [AshleyPath]" if True:
                                ...
                                scene ep5_EMASlivingroom25 with dissolve
                                AS "{cps=10}....{/cps}"
                                AS "So... you like my butt better and you're saying you like me too and not just my butt?"
                                scene ep5_EMASlivingroom26 with dissolve
                            ...
                            "*Choose both.*" if q1 == 0:
                                hide screen INT with dissolve1
                                PL "Sorry, [AS], I can't decide. You both got such great asses. If it was up to me, I'd choose both of them!"
                                PL "I think yours has the nicer shape. It's perkier and rounder. [EM]'s is a lil' smaller and cuter... It's more normal kind of sexy, I guess?"
                    ...
                    if not _in_replay:
                        show screen c_fail
                    AS "Nothing to say?"
                    AS "Boooring! {w=1}You're a pussy, you know that? You're fine staring at a girl's butt when she's not looking..."
...
label ep5_ASsexscene:
    ...
    $ renpy.pause (delay=1)
    show screen INT with dissolve1
    "This bitch is a certified psycho, goddamnit! But she's right, she's got me by the balls. Both literally and figuratively."
    hide screen INT with dissolve1
    ...
    AS "Pffft... what a pussy! A little threat and you go all limp? You're pathetic, you know that?"
    ...
    show screen alt_cam_flash with dissolve1
    "Oh god, what the hell is this crazy lady doing now? She did this shit last time too! Is she just gonna stuff my cock in her mouth whenever she damn well pleases?"
    hide screen INT with dissolve1
    ...
    PL "Shit..."
    scene ep5_EMASlivingroom33 with dissolve
    PL "SHOUTING* Ummm... No thanks, [EM]! I'm good, I think [AS] is too!"
    ...
    AS "Goddamnit, [PL]! Can't you even aim right? You still got it all over my face, you stupid bastard!"
    AS "Damn, you're useless... {w=1}Good thing theres a box of kleenex here. You'd be so fucked otherwise."
    AS "Now, hurry and pull up your pants. [EM] will be here any second now!"
    AS "Aha ha ha, that was such a fucking rush!"
    stop music fadeout 4
    scene black with fade1
...
label ep5_EMstarebuttpass:
    if Temp == 0:
        ...
        scene ep5_EMASlivingroom55 with dissolve
    PL "Ummm... {w=1}So, [AS], about the gaming session with [EM]..."
    hide screen tip
...
label ep5_EMASlivingroomb:
    ...
    EM "Ha, maybe I should be just be like you and play games all night!"
    ...
    EM "{cps=10}....{/cps}"
    PL "What? Really?"
    PL "It was you, [EM]? I really thought it was [AS]. Thought she was trying to mess with me like always..."
    PL "Ummm... {w=1}I don't know what to say... {w=1}Was it good?"
    EM "{cps=10}....{/cps}"
    scene ep5_EMASlivingroom61 with dissolve
    EM "What? I was hungry! It was just sitting there and it looked good!"
    ...
    if ep4_EMfirstkiss >= 2:
        ...
        EM "Ummm... I don't wanna talk about it. It didn't happen. Both of you forget about it right now!"
        scene ep5_EMASlivingroom69 with dissolve
        EM "Now, enough stalling, let's do this. You ready, [PL]?"
        EM "Lessee, what's good for the first event?"
    elif ep4_EMfirstkiss >= 1:
        scene ep5_EMASlivingroom69 with dissolve
        EM "Yeah, how 'bout no? Idiot! You already tricked me into giving you one!"
        EM "You're not getting anything like that from me, not this time! All you have in store for you right now is a sound beating."
        EM "Prepare to be humiliated!"
        scene ep5_EMASlivingroom71 with dissolve
        AS "Wait... {w=1}you guys already made kissy faces with each other? When? How come I haven't heard anything about this?"
        AS "Em's not such an innocent girl after all. Way to go, [EM]!"
        scene ep5_EMASlivingroom70 with dissolve
        EM "Noooooo!" with vpunch
        EM "It wasn't like that at all. It wasn't me, I swear! This guy did it all. Took me by surprise is all!"
        EM "Plus, it was just an innocent peck on the cheek! It was nothing at all like what you're thinking!"
        scene ep5_EMASlivingroom69 with dissolve
        EM "Now, enough stalling, let's do this. You ready, [PL]?"
        EM "Lessee, what's good for the first event?"
    elif True:
    ...
    AZ "At least at first. {w=0.5}But, true to her words, subsequent events saw [EM] demolishing you soundly. In game {w=0.5}after game {w=0.5}after game."
...
label ep5_dinner:
    ...
    EM "Shush! Just finish these first, and I'll get you more when you're done."
    ...
    LU "MOTHERFUCKING PIZZAAAAAAA!!!" with dpunch
    ...
    AS "Oh? What about this morning with [PL]'s breakfast? What happened there, hmmm?"
    EM "{cps=10}....{/cps}"
    ...
    $ quick_menu = False
    scene black with fade1
    centered "{size=35}{cps=20}After she finished, [AS] made an excuse to leave the table early and left the cleaning up to [EM] again...{/cps}{/size}{w=2.5}{nw}"
    stop music fadeout 4
    $ renpy.pause (delay=2)
