...
label ep7_start:
    ...
    if ep6_leanchoicevar == False:
        ...
        $ quick_menu = False
        centered "{size=35}{cps=20}Previously on Halfway House...{/cps}{/size}{w=2.5}{nw}" with dissolve2
    ...
    if ep6_leanchoice == 1:
        ...
        EM "Ughhh... I keep saying it... but it's not UGLY!" with vpunch
        LU "Right, sorry! Wrong choice of words.... ummm... I guess that must mean you put it on him? Uhhh... good going, [EM]..."
        ...
        LU "Hmmm... I dunno... you sure you're not interested in [PL]? Like, more-than-a-housemate kinda interest?"
...
label ep7_train_night:
    ...
    if ep6_leanchoice == 2:
        ...
        "{cps=10}....{/cps}"
        "Arghhh! Fuck it, I'm too young to have to worry about shit like this! Let's just see how things go and just deal with it as it comes."
        hide screen INT with dissolve1
    $ renpy.pause (delay=2)
    ...
    AS "Anyway... as I was saying, the important thing here is that we'd never do that shit while we're with you, get it?"
    AS "And right now you're with us, so how 'bout showing a lil' respect?"
    ...
    PL "Hmmm... I guess you're right. That would kinda suck... but you know what I think? I think you'd do something like that anyways [AS]."
    ...
    AS "Lucky for you I have extremely refined tastes!"
    AS "A guy would need to be something really special for me to even notice him, so you don't have to worry about that... {w=0.5}for now."
    ...
    if ep6_leanchoice == 1:
        ...
        AS "Only thing I have to worry about are the other passengers... and there's no one around except those two."
        AS "I very much doubt they've got the balls to start any trouble with me."
        ...
        label ep7_EMmakeout:
            ...
            if emLP >= 24 or emCP >= 17:
                ...
                menu:
                    "*Kiss her.* [EmilyPath]" if True:
                        ...
                        scene ep7_station49 with dissolve
                        PL "You promised we would continue where we left off before... Now is as good a time as any, right? I mean... we have some time before [AS] gets back."
                        scene ep7_station46 with dissolve
                        ...
                        if emLP >= 30 or emCP >= 21:
                            ...
                            EM "!!!"
                            EM "Ummm... whatever! Just hurry it up before I change my mind!"
                            menu:
                                "*Kiss her again.* [EmilyPath]" if True:
                                    ...
                                    menu:
                                        "*Go for a deeper kiss. [EmilyPath]*" if True:
                                            hide screen INT with dissolve1
                                            ...
                                            hide screen INT with dissolve1
                                            menu:
                                                "*Kiss her neck.* [EmilyPath]" if True:
                                                        ...
                                                        menu:
                                                            "*Go for it!* [EmilyPath]" if True:
                                                                ...
                                                                label alt_cam42_return:
                                                                    ...
                                                                    EM "Eeeeep!"
                                                                    PL "Sorry, [EM]. Was that too much? I just thought it'd be okay..."
                                                                    PL "You looked like you were enjoying yourself, and I wanted to do more for you... I guess..."
                                                                    ...
                                                                    EM "You should... ummm.... do those sort of things when we're alone!"
                                                                    ...
                                                                    scene ep7_station57 with dissolve
                                                                    PL "Uhhh... okay. Does that mean we can continue this later? Like in your room, maybe?"
            ...
            EM "Nothing's going on. We just had a bit of talk is all. [PL] was just a bit worried about how [SG] is going to handle his new look."
            ...
            AS "Hmmm... I don't buy it. But, fine... you two can keep your little secret."
        ...
        AS "{b}Today{/b}... riiight... Your batteries always start to run out around this time. Don't try making excuses just coz [PL] is here."
        ...
        label ep7_AS_Trainsex:
            ...
            label ep7_AStrainsexL:
                ...
                AS "I need to teach you to not take me for granted... it's high time you pay the price, you bastard!"
                ...
                AS "While, on the inside, this is what you've been hoping for all along, haven't you?"
                ...
                play sound thud
                AS "You like that, huh? Tell me the truth, where would you rather be right now? In here with me or outside staring at those two sluts from before?"
                ...
                AS "No, you don't get fuck me, you idiot! Not now, and maybe even not ever! I keep telling you this, but you're not man enough!"
                ...
                menu:
                    "*Make [AS] feel good.* [AshleyPath]" if True:
                        hide screen INT with dissolve1
                        ...
                        menu:
                            "*Make [AS] cum!* [AshleyPath]" if True:
                                call treset
                                hide screen INT with dissolve1
                                label ep7_AScumrepeat:
                                    ...
                                    label alt_cam43_return:
                                        ...
                                        if Temp == 1:
                                            ...
                                            AS "Now, let me just catch my breath for a bit and we can head back... {w=0.5}soon as I put on my pants... {w=0.5}Where're my damn panties? Find them for me, will you?"
                                        hide screen alt_cam_flash with dissolve1
                                        ...
                                        label alt_cam44_return:
                                            ...
                                            menu:
                                                "*Make [AS] cum again!* [AshleyPath]" if True:
                                                    $ Temp = 1
                                                ...
                                                "*Finish her off completely.* [AshleyPath]" if C_Count >= 3:
                                                    ...
                                                    PL "I wouldn't do that... ummm... well, I kinda thought about it, but I dunno... it felt wrong somehow. Plus, c'mon, [AS], I made you cum your brains out..."
                                                    ...
                                                    AS "Pffft... shut up. You weren't that great! But I guess you do deserve a little something for being {b}you{/b}... for not betraying my expectations..."
                                                    ...
                                                    AS "Yeah, yeah... wipe that dumb look off your face. You heard me right, you get to fuck me in the ass... Been a while since I've had a cock up there..."
                                                    ...
                                                    menu:
                                                        "*Ram it in!* [AshleyPath]" if True:
                                                            ...
                                                            $ asCP += 2
                                                        "*Enter her slowly.*" if True:
                                                            scene ep7_station151 with dissolve
                                                            AS "Mmmmmmmhhhhh...."
                                                            AS "C'mon, dude! What's with this sissy bullshit? Did I ask you to be gentle with me?"
                                                            PL "{cps=10}....{/cps}"
                                                            AS "Nevermind... just hurry up and fuck me... We've been in here for a while... We're gonna reach the station any minute now."
                ...
                label ep7_AStrainsexdone:
                    ...
                    UN "Whoa... scaaary! You're super edgy... I'm not surprised based on your look, but calm the hell down..."
                    ...
                    menu:
                        "*Say yes.* [gr](TrainGirlMeet)" if True:
                            hide screen INT with dissolve1
                            ...
                            PL "So, can I get your name... maybe your phone number too? We could get in touch that way and set up a meet or something."
                    ...
                    $ quick_menu = False
                    scene black with fade1
                    centered "{size=35}{cps=20}You walk back to the passenger car to join the girls...{/cps}{/size}{w=2.5}{nw}" with dissolve
                    ...
                    AS "Hmph, whatever! I don't actually care so don't let any of this get to your head. Now, sit down, we'll reach the station soon."
...
label ep7_stationtrans:
    ...
    if ep6_leanchoice == 1:
        ...
        EM "Hm... wouldn't you like to know... I'm not gonna tell you though!"
        ...
        EM "Boooooo!"
        PL "Ummm... guys? I think we should hurry it up on getting home. It's getting late, and I'm worried about what [LU] said about [SG]."
    ...
    PL "Ummm... yeah... okay, [SG]... if you think that'll make you feel better... but you're not having dinner with us?"
    scene ep7_arrive10 with dissolve
    ...
    EM "But it's true that you don't have a lot of clothes... You need more! How about if we go shopping for them some time? I'll help you out!"
    PL "{cps=10}....{/cps}"
    ...
    EM "Shut up! I'm not that bad! I'll pick some really cool clothes for him, you'll see!"
    EM "I know what hot guys look like... so I'll just pick similar stuff! It can't be that hard."
    ...
    EM "Hm... I haven't seen that happen even once since I've been here. She always waits to eat with us even if it's super late."
    ...
    EM "Hmmm... that doesn't sound like her at all. Make sure you have a proper talk with her as soon as you can... Get it all squared away, okay?"
    $ renpy.pause (delay=0.5)
    show screen INT with dissolve1
    ...
    AS "Ughhhhh!! Quit trying to prop up his ego all the time, [EM]."
    AS "His head is big enough as it is! It's not that big a deal anyway... It's just going to work. We all had to do it."
    ...
    pause
    AZ "You decided to give up trying to chat with the girls and followed [EM]'s example, directing all your attention to dinner..."
    ...
    if emLP >= 36 or emCP >= 21:
        ...
        pause
        AZ "Once she finished, [EM] pretty much confirmed your suspicions by giving you a kiss on the cheek as proof of how happy she is with you for helping her out."
        $ Temp = 1
    elif True:
        show screen c_fail
    ...
    if Temp == 1:
        ...
        AZ "Once she finished, [EM] said goodnight and went upstairs to her room..."
    call treset
...
label alt_cam45_return:
    ...
    PL "If nothing else, your elegant sense of style definitely blows the both of them out of the water."
...
label ep7_SGnightvisit:
    if _in_replay:
        ...
        $ disable = 1
    menu:
        "*Give [SG] a hug* [SamanthaPath]" if True:
            ...
            if sgCP >= 26:
                ...
                hide screen c_pass
                menu:
                    "*Ask her.* [SamanthaPath]" if True:
                        hide screen INT with dissolve1
                        PL "Ummm... so, [SG], before I head up to bed, there's something I'd like to ask..."
                        ...
                        show screen INT with dissolve1
                        menu:
                            "*Say yes! Let's see if she really means it...*  [SamanthaPath]" if True:
                                hide screen INT with dissolve1
                                ...
                                SG "Let's see if little [PL] is equally straightforward..."
                                play sound rustle
                                ...
                                SG "Shhh... just let me take care of everything... Now, stand up for me."
                                ...
                                PL "Wow... what was that, [SG]? I've never had anything like that before! It was like a goodnight kiss... but on my dick!"
                                ...
                                $ renpy.pause (delay=0.5)
                                show screen INT with dissolve1
                                "SHIT!!! Her role-playing is pushing me to the edge... and speeding up like that don't help either."
                                ...
                                menu:
                                    "*Let it go!*" if True:
                                        ...
                                        PL "Good night, [SG]. I'm glad I managed to make you feel better, and I'm happier still you've changed your mind about us."
                                        SG "Yes, [PL], I'm glad too... Good night."
                                        $ sgCP += 5
                                        $ ep7_SGnightfp = 1
                                    "*Ask her to stop.* [SamanthaPath]" if True:
                                        ...
                                        PL "Mind using that mouth of yours on me, mom? I've never had a girl give me a blowjob before... Wouldn't you like to be the one to show me how it feels?"
...
label ep7_newday:
    ...
    SG "Wait, [EM], while I'm glad you're starting to dress more ladylike but... isn't that skirt a little too short?"
...
label ep7_garage_trans:
    ...
    EM "Just use your phone to find [EL]'s place. [SG] probably already set up the route for you to follow or something... Just check the app."
    ...
    PL "Hmmm.... I think I'm making pretty good time, so maybe I can take a sec to take a better look at this thing..."
    menu:
        "*Check out the bike.* [gr](PIMeet)" if True:
            ...
            label alt_cam46_return:
                ...
                "Who's the dude though? Must be the owner of the bike... Shit... hope he's not a friend of [HO]..."
                ...
                PL "{cps=10}....{/cps}"
                scene ep7_PLgarage12 with dissolve
                PL "Oh, yeah, it sure is! Wish I had something like that..."
                scene ep7_PLgarage16 with dissolve
                CU "See, [PI]?"
                PI "Bah... men!"
                ...
                PL "Ummm... I.... uhhh.... I have to get to work!"
                ...
                CU "I didn't know the old bastard was hiring. He fired the last motherfucker for stealing some of his shit and refused to hire anyone else after."
                ...
                $ ep7_PImeet = 1
        "*Nah... better hurry to [EL]'s.*" if True:
...
label ep7_garage:
    ...
    EL "Hmmmm...."
    EL "You look good... how've you been doing? I see you still have that thing on your arm but, other than that, you sure you're ready for this?"
    ...
    PL "{i}Little{/i} Sam is just fine. She was feeling a bit down up until recently coz of all the shit that happened to me."
    ...
    EL "Anyway, that there door leads to my office and the storeroom of sorts."
    ...
    EL "Alright... that's the tour... Now, come over here and have a look see at this! Bet even someone as slow as you will find this interesting."
    scene ep7_PLgarage50 with dissolve
    EL "Wait till you see this engine... You don't see anything like this every day, I'll tell you that right now!"
    ...
    EL "Sigh... you're no fun... But just give me some time, I'll turn you into a gearhead too before long."
    ...
    EL "Bah! Keep up that kinda talk, and I'll show you how mean a boss I can be!"
    ...
    EL "Hmph... this ol' gal has been with me close to 40 years now! She hasn't let me down yet!"
    ...
    UN "Oh god, sorry about earlier! There're a lot of shit turds around here that come around trying to score with one of us... well, mostly [AS] but still..."
...
label ep7_LIattack:
    ...
    LI "So... I heard you called [NA] a \"beautiful lady\" the second you laid eyes on her."
    if sgCP >= 18:
    ...
    menu:
        "[gr]*Take a closer look at her ass.*" if True:
            hide screen INT with dissolve1
        ...
        "*I don't think it's such as good idea.*" if disable == 1:
            ...
            label ep7_LIbuttpass:
                ...
                LI "I'm always right. Growing up, I always went after the guys Sam and Nadia had the hots for! Just to test them out, see? I'm just protecting my girls."
