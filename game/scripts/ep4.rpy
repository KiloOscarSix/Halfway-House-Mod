...
menu:
    "*Sit up.*":
        ...
        if ep3_HOanger == 4:
            ...
            "She even comforted my like I was some scared little baby...."
        ...
        label ep4_EMcoverherup:
            ...
            menu:
                "*Give her my my blanket.* [EmilyPath]":
                    ...
                    menu:
                        "*Cover [EM]*":
                            ...
                            PL "{cps=10}....{/cps}"
                            show screen INT with dissolve1
                            "Man, she's gotta cute sleeping face. Kinda make me wanna mess with her a bit..."
                            ...
                            "I wonder why she's so hung up on it."
                            ...
                            EM "But you covered the wrong thing... I'm not wearing shorts so it's not my legs that's freezing."
                            ...
                            menu:
                                "*Stop her strap from falling.* [EmilyPath]":
                                    hide screen INT with dissolve1
                                    ...
                                    EM "Pfff, looks like you need add cringey to that list too."
                                    $ emLP += 2
                                "*Perverts gonna perv...*":
                                    hide screen INT with dissolve1
                ...
                "*Ewww. I'm not some romance novel protag!*" if disable == 1:
                    ...
                    PL "Thought I let you sleep in for a bit and watch some TV."
...
label ep4_PLbathroom:
    ...
    menu:
        "*Time to take off this crappy Sunday dress.*":
            hide screen INT with dissolve1
            scene black with fade
            PL "FUCK!{nw}{w=1.5}" with vpunch
            PL "GODDAMNIT!{nw}{w=1.5}" with vpunch
            PL "Get off you mother fucking...{nw}{w=2}"
            ...
            menu:
                "*Relieve critically full bladder.*":
                    hide screen INT with dissolve
                    ...
                    show screen INT with dissolve1
                    menu:
                        "*Wash up and try to get dressed.*":
                            hide screen INT with dissolve1
                            scene ep4_PLbathroom10 with dissolve
                            $ renpy.pause (delay=1)
                            scene black with fade1
                            centered "{size=45}After doing a half-assed job of washing yourself...{/size}{w=2}{nw}"
                            PL "FUCK!{nw}{w=1.5}" with vpunch
                            PL "GODDAMNIT!{nw}{w=1.5}" with vpunch
                            PL "C'mon you mother fucking...{nw}{w=2}"
                            PL "{cps=10}....{/cps}{nw}{w=2.5}"
                            ...
                            menu:
                                "*Call for [EM].*":
                                    ...
                                    EM "OK, quiet down and close your eyes. Let's see if we can get this done."
                                    ...
                                    label ep4_EMfirstkissR:
                                        if _in_replay:
                                            ...
                                            $ emLP = 15
                                            $ emcp = 9
                                        centered "{size=45}After struggling for a bit Emily finally manages to get your shirt on...{/size}{w=3}{nw}"
                                        ...
                                        if emLP >= 15 or emCP >= 9:
                                            ...
                                            show screen INT with dissolve1
                                            menu:
                                                "*Turn my cheek to her.* [EmilyLovePath]":
                                                    hide screen INT with dissolve
                                                    ...
                                                    EM "And you better not mention any of this to the others. Else I'll really hurt you bad."
                                                    ...
                                                    $ emLP += 2
                                                    $ ep4_EMfirstkiss = 1
                                                "*Face her at the last second so I can catch her on the lips!* [EmilyCorruptionPath]":
                                                    hide screen INT with dissolve1
                                                    ...
                                                    play sound beatdown
                                                    scene ep4_beating
                                                    centered "{size=45}Emily proceeds to give you a beating. It doesn't hurt at all...{/size}{w=3}{nw}"
                                                    scene ep4_PLbathroom23 with dissolve
                                                    EM "There! That's what someone like you deserves."
                                                    EM "And you better not mention any of this to the others. Else I won't stop with just my fists. I'll kick too!"
                                                    scene ep4_PLbathroom35 with dissolve
                                                    EM "Now that you got what you wanted and You're washed and dressed."
...
label ep4_PLbathroomdone:
    ...
    EM "Ughhhh! You've been infected by him [SG]. You like teasing me too now. You weren't like this before he came along!"
    SG "Ha, ha, ha. Sorry, but I can't help it. Your reaction to his nonsense is just too cute."
    PL "Nonsense? It's not nonsense. I just being my usual charming, handsome and considerate self!"
    ...
    PL "Yeah, sure [SG]. I'm ready as I'll ever be. Can't wait to leave this place."
...
label ep4_EMSGhospital:
    centered "{size=45}After the discharge process is complete...{/size}{w=2}{nw}"
    ...
    EM "I just choose to look at the bright side of things, that's all."
...
label ep4_EMSGdrive:
    ...
    PL "Please don't tell me you gonna spend all day wearing what you have on now."
    ...
    EM "I don't need your worry about that kinda thing! I know how to take care of myself."
    ...
    scene black with fade1
    play sound chime
    centered "{size=45}After a while...{/size}{w=2.5}{nw}"

label ep4_EMSGcoffeeshop:
    scene ep4_EMSGcoffeeshop1
    $ renpy.pause (delay=1)
    show screen INT with dissolve1
    ...
    NA "You look good. If I didn't know better I would never even guessed you've been through that horrible nightmare."
...
label ep4_NAcoffeeshoppanL:
    ...
    NA "I'm [NA]. I've know Sam for ages. And have been trying to keep her out of trouble since."
    NA "Glad to finally have some help on that front. I have to thank you for saving her butt."
    PL "Happy to meet you too [NA]. Wow, I definitely expected this from [SG]'s friend."
    PL "You're beautifull too! It's great to...{nw}{w=2.5}"
    ...
    PL "And I'm just stoked to find out I was right. I guess I was hoping all of [SG]'s lady friend to be as hot as she is."
    ...
    NA "I was the responsible one, Liz was the reckless trouble maker and Sam was the follower."
    scene ep4_EMSGcoffeeshop16 with dissolve
    ...
    NA "Hmmmm? Don't know what you mean..."
    scene ep4_EMSGcoffeeshop15 with dissolve
    ...
    PL "I hope she's not really quite as hard core as [AS] though, ha, ha."
    scene ep4_EMSGcoffeeshop21 with dissolve
    ...
    SG "As for that hard core part. Well, as long as you don't start making eyes at her the moment you meet, like you've been doing so far. You'll be fine."
    scene ep4_EMSGcoffeeshop18 with dissolve
    ...
    $ renpy.pause (delay=1)
    scene black with fade1
    centered "{size=45}You spend some time talking with Samantha...{/size}{w=3}{nw}"
label ep4_EMcoffeeshoppanL:
    ...
    EM "Ughhhh! You're too soft on him [SG]!. You need to be a lot more strict with this guy."
    ...
    PL "The dress itself is cute. But adding those garters and hose is particularly inspired!"
...
label ep4_EMcoffeeshoptrip:
    ...
    scene ep4_EMSGcoffeeshop45 with dissolve
    SG "Hmmm... I don't know. I don't think [EM] is bold enough to do something so straight forward but..."
    ...
    SG "Don't worry. If [EM] really hates someone they'll know about it. How she's acting towards you is a long away from hate. Trust me."
    ...
    menu:
        "*Eat the mass of sugary sweetness*.":
            hide screen INT with dissolve1
            scene black with fade1
            ...
            PL "As for what happened to me. Well, that just coz I wasn't strong enough to beat the guy. Nothing to do with you."
    ...
    SG "[NA]! Thanks for the cakes it was lovely. Sadly it's all gone now and I think it's about time I get this kid home."
...
label ep4_SGdrivehome:
    ...
    PL "So don't tell them? Say you gotta take me out for a health check up or something."
    scene ep4_SGdrivehome5 with dissolve
    SG "{cps=10}....{/cps}{nw}{w=1.5}"
    ...
    scene black with fade1
    stop music fadeout 4
    centered "{size=45}You continue to spout more bullshit all the way home...{/size}{w=2.5}{nw}"
...
label ep4_SGlivingroom:
    ...
    SG "You can watch TV or something. Or if you want there's a bunch of DVD's in the cupboard you can watch."
    ...
    scene black with fade
    SG "Now come on sit your butt down on the couch..."
    ...
    stop music fadeout 4
    centered "{size=45}You spend a couple of hours completely absorbed...{/size}{w=2}{nw}"
    ...
    PL "{cps=10}....{/cps}"
    LU "So? Watcha think? Am I a Bro or what? Ha, ha, ha."
    ...
    LU "Seriously? You never watch porn at home hiding form your parents?"
    ...
    LU "Sure you do. It's a DVD. Should be a menu or someshit where you can pick your scenes and stuff."
    show screen INT with dissolve1
    ...
    menu:
        "*Let's watch this thing!*":
            ...
            PL "But personally, I'd love for her to be my teacher when I was a kid."
            ...
            scene black with fade1
            centered "{size=45}So... The two of them went on and on like this for quite a while...{/size}{w=3}{nw}"
            ...
            PL "Shit man, you the ass fuck professor or something. You talk like you're a pro at this shit."
            ...
            "{cps=10}....{/cps}"
            "Dayum... this dude is really pounding the shit outa her..."
            label ep4_PLcaught:
                if _in_replay:
                    play music dark2
                    scene ep4_PLlivingroom48 with dissolve
                ...
                PL "{cps=10}....{/cps}"
                PL "Okay, okay [SG]. I get it. So could you please turn it off now. I don't think I can take anymore embarrassment for today."
                ...
                if sgCP >= 20:
                    ...
                    SG "And I can't help but notice the lady you chose to watch bear a passing resemblance to someone?"
                else:
                ...
                SG "Once you've done some work for [EL] and make yourself some money. You can buy something to actually play it on."
                ...
                SG "I won't allow that. What if you had an accident and get it dirty or something? I doubt you'll just be watching and without doing anything else!"
                ...
                PL "What happened to \"bro's before hoes\" and \"no man left behind\" and all that kinda junk?"
                ...
                LU "You're kinda safe. [SG]'s soft on you. She was soft on you before, now she's practically melting after getting yourself hurt to help her out."
                LU "So I figure she'd let you off easy even if I left you."
                LU "And I was right! She didn't even yell at you!"
                scene ep4_PLlivingroom70 with dissolve
                PL "{cps=10}....{/cps}"
                PL "That may be. But it was still mortifying as fuck! How'd you feel if you were watching porn and then looked up to see your mom or sister in the room?"
                scene ep4_PLlivingroom69 with dissolve
                ...
                hide screen INT with dissolve
                scene black with fade1
                centered "You spent hours watching the fantasy flick and doing pretty much nothing else..."
                centered "A little later you had Samantha make some lunch for you and you both ate in the living room..."
                centered "She made diddly squat for Luis. Seems he's on her shit list..."
                centered "After that you decided to explore the house checking out parts not included in the tour..."
                centered "Before you know it, it's evening..."
                stop music fadeout 4
...
label ep4_SGEMASdinner:
    ...
    EM "NO IT'S NOT!"
    EM "I just started. How can it be ready so soon? Why are you here anyway? Go someplace else. You're distracting me!"
    ...
    PL "She's cute as a button and fierce as all heck. She got no problems beating on me even though I'm all hurt like this."
    ...
    LU "{cps=10}....{/cps}{nw}{w=1.5}"
    LU "... What's wrong [EM]. Why so quiet? Where's the usual angry retort?"
    scene ep4_SGEMASdinner10 with dissolve
    EM "{cps=10}....{/cps}"
    EM "In case you guys haven't noticed, I'm trying my best to ignore you."
    EM "I'm in this kitchen alone. Peacefully having fun cooking dinner after a hard days work."
    EM "No annoying flies bothering me with their drivel. So I'm a granny or whatever. I don't care! I haven't heard any of it."
    ...
    EM "\"Is done yet?\"... \"Is it ready yet?\"... \"Hurry up! I'm hungry!\"..."
    ...
    AS "Yeah good for you. You keep enjoying that like a horny little snot nosed bastard that just found out what boobies are."
    ...
    if ep2_ASmorningforeplay == 1:
        ...
        "I'll just hold on to this even though I got no use for it."
        ...
        AS "Don't want to get in her shit list my self."
        scene ep4_SGEMASdinner19 with dissolve
        $ renpy.pause (delay=1.5)
        scene ep4_SGEMASdinner25 with dissolve
        $ renpy.pause (delay=1)
    ...
    AZ "Samantha just keeps fussing over you like an over protective mother. Going so far as to cut up your meat for you..."
    scene black with fade
    stop music fadeout 4
    centered "After dinner deciding to steer clear of [EM] for a bit you head out to the sitting area out back to get some air..."
label ep4_ASoutside:
    ...
    $ renpy.pause (delay=1)
    show screen INT with dissolve1
    "Ohhhh... Nice place to chill. I should just sit for a bit and do some star gazing, enjoy my freedom and digest the meat I just demolished."
    hide screen INT with dissolve1
    ...
    PL "And so is the fact that you're sitting out here sulking by yourself means you can't talk about it with the others."
...
label ep4_ASstraddlePL:
    ...
    if ep2_ASmorningforeplay == 1:
        ...
        PL "{cps=10}....{/cps}"
        AS "What's wrong? To scared? Don't worry we won't even have to take our clothes off."
        ...
        menu:
            "[gr]*Fuck it! Grab them boobies!*":
                ...
                menu:
                    "[gr]*My mom used to say you gotta listen to girls...*":
                        ...
                        AS "And what are you a boyscout? Don't call me by my name! Tell me what you really think of me!"
                        ...
                        hide screen INT with dissolve
                        menu:
                            "[gr]*Be a little rougher with her.*":
                                ...
                                AS "Hmffff... {w=0.5}yeah... {w=0.5}but I told... {w=0.5}you to stop calling me by name..."
                                AS "Shit! Harder! Be rougher with me..."
                                PL "No, not yet. First tell me what you'd like me to call you."
                                AS "Hmffff... {w=0.5}I don't know... {w=0.5}something nasty... {w=0.5}be real mean..."
                                menu:
                                    "*Give her what she wants.*":
                                        ...
                                        AS "Ughhhh! FUCK!{nw}{w=2}" with vpunch
                                        ...
                                        AS "I'm just a little more horny that usual, that's all. So don't start thinking you're all that! Asshole!"
                                        ...
                                        AS "If it soaks through ruin my pants I'm making you pay for it. Leather ain't cheap you know."
...
label ep4_ASboobsqueezepass:
    ...
    AS "Damnit! Fine but I'm not about to bare my soul to you."
    ...
    AS "{cps=10}....{/cps}"
    AS "And now my sister tells me my mom wants me back. I should go meet the old bastard and beg for forgiveness or something."
    ...
    AS "They don't really want me back okay. Well except for my sister."
    ...
    scene ep4_ASoutside37 with dissolve
    AS "Stop it with that bullshit! You don't know my parents all right!"
    ...
    AS "Arghhhh! This is why I didn't want to talk to anyone about this!"
...
label ep4_SGEMbedroom:
    ...
    "I think I'll avoid trying to have a look anytime soon."
    hide screen INT with dissolve1
    ...
    "I guess rich heiresses think everyones their maids..."
    hide screen INT with dissolve1
    ...
    PL "But for now though since I got absolutely nothing to do in this room, might as well call it day."
        ...
        "*Get ready for bed.*":
            ...
            if sgCP >= 20:
                ...
                label ep4_SGbedroomgame:
                    ...
                    menu:
                        "\"How about showing me a view from the back again?\"":
                            ...
                            SG "I'm feeling a little conflicted right now all right? I'm supposed to be your elder. Your counselor and your caretaker."
                            ...
                            SG "Fine! You win this time. But you better not let any of this get out to the others all right?"
                            ...
                            menu:
                                "*Move closer for a better view*":
                                    ...
                                    PL "{cps=10}....{/cps}"
                                    SG "There that's it. You're not getting anymore out of me Mister!"
                                    ...
                                    SG "First I catch you looking at porn with middle aged ladies in it. And now you're asking me to do these kind of things."
                                    ...
                                    menu:
                                        "[gr]*Ask [SG] for some help, straight up*":
                                            hide screen INT with dissolve1
                                            ...
                                            scene ep4_SGEMbedroom42 with dissolve
                                            SG "And you can... ummmm... take care of your business..."
                                            scene ep4_SGEMbedroom43 with dissolve
                                            ...
                                            menu:
                                                "[gr]*Cum on [SG]'s butt!*":
                                                    ...
                                                    PL "Arghhhhh! FUCK! Here it comes {i}Mommy!{/i}"
                                                    ...
                                                    menu:
                                                        "*Open dresser door.*":
                                                            ...
                                                            EM "Seeing you in your undies don't really bother me. I even help you get dressed before remember?"
                                                            ...
                                                            EM "You were jerking off and went and mess up the sheets!"
                ...
                label ep4_takemeds:
                    ...
                    menu:
                        "*Take my meds.*":
                            ...
                            PL "You need some thing [EM]? I thought you were mad at me."
...
label ep4_bedtime:
    ...
    if sgCP >= 24:
        "And that shit with [SG] was just crazy. I can't believe that happen."
