...
label ep3_start:
    ...
    menu:
        "*Shit! I need to check right now!*":
            ...
            "{cps=10}....{/cps}{nw}{w=1}"
            "Man, I think the drugs making me loopy. My mind just keeps rambling nonsense."
            hide screen INT with dissolve1
            ...
            PL "After that he pulled out a stick outta nowhere and started beating me with it."
            ...
            PL "He, he, he. Man, it was soooo satisfying to watch."
            ...
            KU "I just need you to hold my hand and try to squeeze as hard as you can."
            ...
            menu:
                "[gr]*Fuck that! Let's just enjoy her soft hands a bit.*":
                    hide screen INT with dissolve1
                    ...
                    menu:
                        "\"Nothing, just enjoying your soft hands.\" [KuniedaPath]":
                            ...
                            show screen INT with dissolve1
                            "He, he. For an adult and a full fledge doctor she sure does get embarrassed easily."
                            hide screen INT with dissolve1
                            $ ep3_KUflirt = 1
                            jump ep3_handsqueeztest
                        "\"Ahh, Nothing! I'll start right now!\"":
                            jump ep3_handsqueeztest
                "*Listen to her and do my best.*":
...
label ep3_handsqueezetestdone:
    ...
    if ep3_KUflirt == 1:
        ...
        PL "I thought you were really cute and the way you held my hands just made it kinda jumped out."
        ...
        show screen INT with dissolve1
        "Wow, she get flustered so easily. Makes me wanna mess with her more..."
        ...
        label ep3_KUflirtfalse:
            ...
            KU "Would you mind if sit down while we wait for Ms. Gail?"
            ...
            KU "Other than that we have a lot of elderly people there. In fact we used to have the eldest living woman in Japan."
            KU "She is even in the Guinness World Records, I think."
            scene ep3_KUhospitalroom8 with dissolve
...
label ep3_SGreturns:
    ...
    EM "Geeze! You worried me for nothing!"
    scene ep3_SGhospitalroom48 with dissolve
    ...
    PL "How bout some nice words of comfort? And make sure say it in the cutest way possible!"
    ...
    menu:
        "[gr]\"Make sure you wear something sexy!\"":
            scene ep3_SGhospitalroom48 with dissolve
            $ renpy.pause (delay=0.5)
            scene ep3_SGhospitalroom51 with dissolve
            $ renpy.pause (delay=1)
        ...
        "\"Cook something nice for me!\"":
            scene ep3_SGhospitalroom48 with dissolve
            EM "Humph! Just because you're hurt doesn't mean you can start acting like baby and make demands!"
    ...
    if ep3_KUflirt == 1:
        ...
        KU "....!{fast}"
        show screen INT with dissolve1
        "Shit! Me and my big god damn mouth."
        hide screen INT with dissolve1
    ...
    SG "Oh, I'm so sorry!"
    SG "Of course Dr. Thank you so much for everything and we apologize for taking up so much of your time."
    ...
    if ep3_KUflirt == 1:
        scene ep3_SGhospitalroom58 with dissolve
        SG "That aside though. I can't help but noticed you were sweet talking her rather fiercely."
...
label ep3_SGdatassagain:
    if _in_replay:
        ...
        $ disable = 1
    menu:
        "*God himself wouldn't be able to ignore that shit!* [SamanthaPath]":
            ...
            PL "What ever I saw in there wouldn't satisfy anything."
...
label ep3_SGdatassdone:
    ...
    menu:
        "*Drink up.*":
            ...
            PL "Hum, how about you just take a load off and we just talk?"
            ...
            label ep3_SGhospitalqmenu:
                menu:
                    ...
                    "\"I have to ask. How're you holding up [SG]?\"" if q3 == 0:
                        ...
                        PL "Anyway just forget about all that crap. I mean, do we really care what a god damn rapist think?"
                        scene ep3_SGhospitalroom86 with dissolve
...
label ep3_SGhospitalbedflirt:
    if _in_replay:
        ...
        $ disable = 1
    menu:
        "*Nudge her feet with my toes.* [SamanthaPath]":
            hide screen INT with dissolve1
            scene ep3_SGhospitalroom90 with dissolve
            $ renpy.pause (delay=1)
            ...
            SG "Carefull though. Girls can be quite vindictive about these kind of things."
...
label ep3_OLhospitalvisit:
    ...
    window hide
    centered "{size=50}A short time later...{/size}{w=1.5}{nw}"
    ...
    if ep2_SGchoked == 1:
        PL "If a friend of yours is being groped, insulted and threaten right in front of you..."
        PL "And getting choked till she almost passes out, what the hell would you do?"
    else:
        PL "If a friend of yours is being groped, insulted and threaten right in front of you, what the hell would you do?"
    scene ep3_SGhospitalroom113 with dissolve
    OL "So you say...."
    OL "Also, You said he hit you with some kind of stick? What exactly did he used?"
    scene ep3_SGhospitalroom112 with dissolve
    ...
    SG "Although I have to agree with you. So far I am not at all happy with how the police is handling this case."
    ...
    menu:
        "\"Of course I'm pressing charges.\"":
            ...
            label ep3_OLpresscharge:
                ...
                scene ep3_SGhospitalroom112 with dissolve
                OL "That's debatable...."
                PL "Fuck! Who's side are you on anyways?"
        ...
        "\"Oh nooo!, Lemme think! YES, I'm pressing charges!\"":
...
label ep3_OLinterviewdone:
    ...
    menu:
        "[gr]*Fuck it! I'm not afraid of that guy. Let's go see him.*":
            hide screen INT with dissolve1
            ...
            OM "If that bastard so much as put one foot outta line. He'll have Freight Train Monroe to deal with!"
            SG "...\"Freight Train\"?"
        ...
        "*[SG]'s right. Why the hell do I need to see the fucker?*":
            if Temp == 1:
                $ Temp = 0
            hide screen INT with dissolve1
            scene ep3_SGhospitalroom118 with dissolve
...
label ep3_HOvisitevent:
    ...
    menu:
        "*Follow [OM] outside.*":
            ...
            OL "Remember, no funny business. That guy behind you's gotta gun."
            scene ep3_HOvisit11 with dissolve
            show screen INT with dissolve1
            "Damn, bastard looks as intimidating as ever..."
            "Still tho, I gave him a good fucking punch. Just look at his goddamn face!"
            ...
            menu:
                "\"What do you want [HO]?\"":
                    ...
                    HO "Still, doncha think you should add Mr. in front of that?"
                    HO "I am old enough to be a Mister! Ha, ha, ha."
                    HO "Anyway, I just got a few thing I wanna make clear before they take me away..."
                "\"What do you want asshole?\" [AngerHollis]":
            ...
            OM "I'm gonna shove my fat fist in your damn mouth if you don't watch what your saying!"
            ...
            menu:
                ...
                "\"The hell would she ever wanna see you?\" [AngerHollis]":
                    scene ep3_HOvisit11 with dissolve
            ...
            OM "Show some respect to the lady. She's not some peice of meat."
            ...
            menu:
                "\"Fine! You win. We're cool.\"":
                    ...
                    $ ep3_HOanger = 0
                "\"Kiss my ass mother fucker!\" [AngerHollis]":
                    scene ep3_HOvisit14 with dissolve
...
label ep3_SGvisitover:
    if Temp == 1:
        ...
        if ep3_HOanger == 0:
            ...
            OM "If you do good and keep love in you heart, you too can pull off moves like that someday."
            PL "{cps=10}....{/cps}{nw}{w=1}"
...
SG "WHAT?" with vpunch
SG "Forgiveness? He asked you to forgive him? Was he sincere? Was he really, trully, sorry?"
...
PL "No, no. I swear. It just... Ummm, I'm not in the best condition to be just standing around talking, so..."
scene ep3_SGhospitalroom137 with dissolve
SG "AH!" with vpunch
...
label ep3_LUASvisit:
    ...
    window hide
    $ renpy.pause (delay=1.5)
    centered "{size=50}....{/size}{w=2.5}{nw}"
    play sound bang
    ...
    PL "You guys are loud, damnit. How's a sick guys supposed to get better with all this noise?"
    ...
    AS "I don't care who you guys perv over but while I'm here, all attention should go to me!"
    PL "{cps=10}....{/cps}{nw}{w=1}"
    ...
    AS "Well... I don' think... I don't think I said anything wrong. He did get beat up... and..."
    ...
    show screen INT with dissolve
    "Well other than that last part, I guess coming form the Queen B. That's quite a compliment."
    ...
    hide screen INT with dissolve
    PL "What you doing here anyways? There's no way the [AS] I know would ever take the time to check up on me."
    ...
    stop music fadeout 1
    play sound dooropen
    scene ep3_LUASvisit7 with fade1
    ...
    if ep2_ASmorningforeplay == 1:
        ...
        PL "Those damn things looks like they could kill."
    ...
    PL "Pardon me my lady.... Now please go urinate and leave me to my solitude."
    AS "Ha, ha, ha, ha."
    ...
    $ renpy.pause (delay=1)
    scene black with irisin
    centered "{size=50}[AS] takes her time...{/size}{w=2.5}{nw}"
    if ep2_ASmorningforeplay == 1:
...
label ep3_LUASvisitend:
    ...
    "Shit, at least bring some comics or porn mag for me to read..."
...
label ep3_EMdinner:
    ...
    PL "Sometimes bad shit just happen and it's out of your control."
    scene ep3_EMdinner3 with dissolve
    ...
    EM "I hope you'll like it. I didn't exactly had a lot of time to make anything good."
    play music loop3 fadein 1
    EM "So I just threw some stuff together with what ever was in the fridge."
    EM "Don't know how good it'll be. If you don't like it, well..."
    EM "Eat it anyway!"
    scene ep3_EMdinner9 with dissolve
    EM "Let's just get this out of t he way first."
    scene ep3_EMdinner10 with dissolve
    show screen INT with dissolve1
    "Geeze, look at her go."
...
label ep3_EMfeedme:
    ...
    "Do I ask?"
    menu:
        "[gr]\"[EM], it's kinda hard to eat like this.\"":
            hide screen INT with dissolve1
            if emLP >=10:
                if not _in_replay:
                    show screen c_pass
                ...
                EM "I thought boys had a lot of pride about this kinda things."
...
label ep3_EMafterdinner:
    ...
    menu:
        "*Ha, ha. Can't pass this chance up!* [EmilyPath]":
            hide screen INT with dissolve1
            ...
            play sound punch2
            stop music
            centered "{size=50}You got hit...{/size}{w=1.5}{nw}" with vpunch
            $ emCP += 2
            $ Temp = 1
            $ renpy.end_replay()
        ...
        "*No, I don't want my testicles crushed!*" if disable == 1:
            ...
            centered "{size=50}You ate the Peach/Apricot thing...{/size}{w=1.5}{nw}"
            hide screen INT with dissolve1
            jump ep3_EMKUmeet
...
label ep3_EMKUmeet:
    ...
    KU "Oh, and you have company. So sorry to intrude."
    ...
    KU "Well of course. You need your stitches removed and not to mention that cast."
    PL "Oh, right."
    KU "Anything else?"
    PL "No can't think of anything else... Oh, wait. Don't you have anymore tests you need to do?"
    PL "For example... another one of those hand squeezing thing?"
    if ep3_KUflirt == 1:
        ...
        EM "Humph! She acts more like a brat that a doctor."
        PL "Sigh..."
...
label ep3_EMnight:
    ...
    EM "Plus, I'm way over here on the couch. I'm no where near you, so that's not sleeping together is it?"
...
label ep3_EMbedtimeqmenu:
    ...
    if q1 and q2 and q3 == 0:
        ...
        pass
    menu:
        "*BOYFRIEND! Gotta ask her about that!*" if q1 == 0:
            hide screen INT with dissolve1
            $ q1 = 1
            scene ep3_EMbedtime5b
            PL "So, speaking of spending nights with boys..."
            PL "You have a boyfriend? I mean, as cute as you are surely have one or... had?"
            ...
            PL "Are you kidding?"
            PL "The school I went to wasn't co-ed. It was just like juvie, except you get to go home everyday."
            PL "And when I'm not in school all I did was hang around doing nothing at all or get into fights."
            ...
            PL "But before I even know what's what, she started dating one of my buddies. So that kinda died before it went anywhere."
            PL "{cps=10}....{/cps}"
            ...
            menu:
                "*Gotta admit that I do.* [EmilyPath]":
                    hide screen INT with dissolve1
                    scene ep3_EMbedtime7b with dissolve
                    PL "Ha, ha. Well, let's say if we take all the girls around me right now for example."
                    PL "[AS]'s an attractive girl I'm not gonna lie. But she hard to figure out and kinda scares me a little."
                    ...
                    scene ep3_EMbedtime11b with dissolve
                    EM "Humph! You're pretty full of yourself with all this talk about which girl is ahead and what not."
                    ...
                    $ emLP += 2
                "*God no! That's embarrassing, deny it!*":
            ...
            if Temp == 1:
                play sound thud
                centered "{size=50}You got hit again.{w=1} It's just a pillow tho...{/size}{w=1}{nw}" with vpunch
            else:
                play sound thud
                centered "{size=50}You got hit.{w=1} It's just a pillow tho...{/size}{w=1.5}{nw}" with vpunch
        ...
        "*Curious about her unfortunate friend.* " if q3 == 0:
            ...
            EM "I have no idea where she and her family went off to after she was discharged. Mom don't know anything either."
...
label ep3_EMbedtimesleep:
    if _in_replay:
        $ ep3_HOanger = 4
    if ep3_HOanger == 4:
        centered "{size=50}...{/size}{w=2.0}{nw}"
        play sound darksfx
        ...
        play music inner fadein 1
        EM "What's wrong! Is something hurt? Are you in pain?"
        ...
        EM "Shhh... It's okay, you're safe. Nothings gonna hurt you here."
        ...
        "Hope this doesn't mean I have to deal with that fucker again within this life time."
